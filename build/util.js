...
function moduleList () {
  return directoryList(path.join(root, 'old_content', 'modules')).map(toModuleName)
}

function exampleList () {
  return directoryList(path.join(root, 'old_content', 'examples')).map(toExampleName)
}

function appList () {
  return directoryList(path.join(root, 'old_content', 'apps')).map(toAppName)
}
...
function toModuleDir (moduleName) {
  return path.join(root, 'old_content', 'modules', moduleName)
}
...
function toExampleDir (exampleName) {
  return path.join(root, 'old_content', 'examples', exampleName)
}
...
function toAppDir (appName) {
  return path.join(root, 'old_content', 'apps', appName)
}
