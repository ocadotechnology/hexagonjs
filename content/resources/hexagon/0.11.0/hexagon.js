...
NumberPicker = (function(superClass) {
  ...
  NumberPicker.prototype.getValue = function() {
    hx.deprecatedWarning(this.selector + ': NumberPicker.getValue()', 'Use NumberPicker.value() instead.');
    return this.value.apply(this, arguments);
  };

  NumberPicker.prototype.setValue = function(value, screenValue) {
    hx.deprecatedWarning(this.selector + ': NumberPicker.setValue(value, screenValue)', 'Use NumberPicker.value(value, screenValue) instead.');
    return this.value.apply(this, arguments);
  };
...
(function(){var Menu, MenuItem, checkEvent, dealWithEvent, dropdownContent, getAllItems, moveSelectionDown, moveSelectionUp, setActive, toggleCollapsible,
  extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
  hasProp = {}.hasOwnProperty;
...
MenuItem = (function() {
  ...
  MenuItem.prototype.addItem = function(item) {
    hx.deprecatedWarning(this.menu.selector + ': MenuItem.addItem(item)', 'Use MenuItem.add(item) instead');
    return this.add.apply(this, arguments);
  };

  MenuItem.prototype.addItems = function(items) {
    hx.deprecatedWarning(this.menu.selector + ': MenuItem.addItems(items)', 'Use MenuItem.add(items) instead');
    return this.add.apply(this, arguments);
  };
...
Menu = (function(superClass) {
  ...
  Menu.prototype.addItem = function(item) {
    hx.deprecatedWarning(this.selector + ': Menu.addItem(item)', 'Use Menu.add(item) instead');
    return this.add.apply(this, arguments);
  };

  Menu.prototype.addItems = function(items) {
    hx.deprecatedWarning(this.selector + ': Menu.addItems(items)', 'Use Menu.add(items) instead');
    return this.add.apply(this, arguments);
  };
...
Localiser = (function() {
  ...
  Localiser.prototype.localiseDate = function(date, useInbuilt) {
    if (useInbuilt) {
      ...
      return date.toLocaleDateString().split('/').map(function(d) {
        return zeroPad(d);
      }).join('/');
    }
  };
  ...
  Localiser.prototype.stringToDate = function(string) {
...
LocaliserMoment = (function() {
  ...
  LocaliserMoment.prototype.localiseMonth = function(month, short) {
    return moment({
      month: month
    }).locale(this.currentLocale).format(short ? 'MM' : 'MMMM');
  };
  ...
  LocaliserMoment.prototype.stringToDate = function(string) {
...
DatePickerFeed = (function(superClass) {
  ...
  DatePickerFeed.prototype.getCalendarDays = function(calStart) {
  ...
  DatePickerFeed.prototype.isSelectedDay = function(year, month, day, startDate) {
    return this.year(startDate) === year && this.month(startDate) === month && this.day(startDate) === day;
  };
  ...
  DatePickerFeed.prototype.isValidDay = function(year, month, day) {
    var tDate, vEnd, vStart;
    tDate = new Date(year, month, day);
    vEnd = this.validEnd != null ? tDate <= this.validEnd : true;
    vStart = this.validStart != null ? tDate >= this.validStart : true;
    return vEnd && vStart;
  };
...
DatePicker = (function(superClass) {
  var deprecatedWarning, setupCalendar, setupDatepicker, setupInput, setupWeek;
  ...
  setupWeek = function(element, data, month, year) {
    ...
    return hx.select(element).view('.hx-day').enter(function(d) {
      ...
      var day, isEndDate, isRange, isStartDate, isValid, screenDay;
      day = d;
      screenDay = !isNaN(day) ? self.localiser.localiseDay(day) : '';
      isValid = _f.isValidDay(year, month, day);
      this.classed('hx-day-today', _f.isToday(year, month, day)).classed('hx-out-of-range', !isValid);
      if (self.selectRange) {
      ...
      if (isValid) {
        this.classed('hx-out-of-month', day == null).on('click', (function(_this) {
          return function() {
            ...
            if (d != null) {
              _f.date(new Date(year, month, day), self._.clickStart);
            }
      ...
      return this.select('.hx-day-text').text(isNaN(Number(screenDay)) ? screenDay : day);
    }).apply(data);
  };
  ...
  setupCalendar = function(force) {
    var _f, days, month, monthName, self, year;
    if (!this.useInbuilt) {
      if (this.dropdown.isOpen() || force) {
        ...
        year = _f.yearNum;
        month = _f.monthNum;
        monthName = self.localiser.localiseMonth(month, false);
        this.monthNameHeader.text(monthName);
        this.yearHeader.text(self.localiser.localiseYear(year));
        days = _f.getCalendarDays(self.localiser.localiseWeekStart());
        this.calendarTable.view('.hx-week', 'tr').update(function(d, element) {
          return setupWeek.call(self, element, d, month, year);
        }).apply(days);
        return this.calendarHeaderView.apply(this.localiser.localiseWeek());
      }
    }
  };
  ...
  function DatePicker(selector1, type, closeOnSelect, selectRange) {
    var _, backMonthButton, calendarElem, calendarMonthHeader, dayNode, forwardMonthButton, icon, inputContainer, monthNode, self, setupDropdown, updateRangePicker, yearNode;
    this.selector = selector1;
  ...
  deprecatedWarning = function(selector, method, alt) {
    return hx.deprecatedWarning(selector + ": DatePicker." + method, "Use DatePicker." + alt + " instead.");
  };

  DatePicker.prototype.getDate = function(endDate) {
    deprecatedWarning(this.selector, 'getDate()', 'date()');
    return this.date(endDate);
  };

  DatePicker.prototype.setDate = function(date, dontSetupInput, suppressCallback) {
    deprecatedWarning(this.selector, 'setDate(date, dontSetupInput, suppressCallback)', 'date(date, dontSetupInput, suppressCallback)');
    return this.date.apply(this, arguments);
  };

  DatePicker.prototype.setDay = function(day, suppressCallback) {
    deprecatedWarning(this.selector, 'setDay(day, suppressCallback)', 'day(day, suppressCallback)');
    return this.day.apply(this, arguments);
  };

  DatePicker.prototype.setMonth = function(month, suppressCallback) {
    deprecatedWarning(this.selector, 'setMonth(month, suppressCallback)', 'month(month, suppressCallback)');
    return this.month.apply(this, arguments);
  };

  DatePicker.prototype.setYear = function(year, suppressCallback) {
    deprecatedWarning(this.selector, 'setYear(year, suppressCallback)', 'year(year, suppressCallback)');
    return this.year.apply(this, arguments);
  };

  DatePicker.prototype.getRange = function() {
    deprecatedWarning(this.selector, 'getRange()', 'range()');
    return this.range();
  };

  DatePicker.prototype.setRange = function(date1, date2, dontSetupInput, suppressCallback1) {
    if (dontSetupInput == null) {
      dontSetupInput = false;
    }
    this.suppressCallback = suppressCallback1 != null ? suppressCallback1 : false;
    deprecatedWarning(this.selector, 'setRange(date1, date2, dontSetupInput, suppressCallback)', 'range(date1, date2, dontSetupInput, suppressCallback)');
    return this.range.apply(this, arguments);
  };
...
TimePicker = (function(superClass) {
  var deprecatedWarning, setupInput, setupTimepicker;
  ...
  function TimePicker(selector1, showSeconds1, buttonClass) {
  ...
  TimePicker.prototype.date = function(val, setTime, suppressCallback1) {
    this.suppressCallback = suppressCallback1 != null ? suppressCallback1 : false;
    return this._.feed.date(val, setTime) || this;
  };

  TimePicker.prototype.hour = function(val, suppressCallback1) {
    this.suppressCallback = suppressCallback1 != null ? suppressCallback1 : false;
    return this._.feed.hour(val) || this;
  };

  TimePicker.prototype.minute = function(val, suppressCallback1) {
    this.suppressCallback = suppressCallback1 != null ? suppressCallback1 : false;
    return this._.feed.minute(val) || this;
  };

  TimePicker.prototype.second = function(val, suppressCallback1) {
    this.suppressCallback = suppressCallback1 != null ? suppressCallback1 : false;
  ...
  deprecatedWarning = function(selector, method, alt) {
    return hx.deprecatedWarning(selector + ": TimePicker." + method, "Use TimePicker." + alt + " instead.");
  };
  ...
  TimePicker.prototype.getHour = function() {
    deprecatedWarning(this.selector, 'getHour()', 'hour()');
    return this.hour();
  };

  TimePicker.prototype.getMinute = function() {
    deprecatedWarning(this.selector, 'getMinute()', 'minute()');
    return this.minute();
  };

  TimePicker.prototype.getSecond = function() {
    deprecatedWarning(this.selector, 'getSecond()', 'second()');
    return this.second();
  };

  TimePicker.prototype.setDate = function(date, setTime, suppressCallback) {
    deprecatedWarning(this.selector, 'setDate(date, dontSetupInput, suppressCallback)', 'date(date, dontSetupInput, suppressCallback)');
    return this.date.apply(this, arguments);
  };

  TimePicker.prototype.setHour = function(hour, suppressCallback) {
    deprecatedWarning(this.selector, 'setHour(hour, suppressCallback)', 'hour(hour, suppressCallback)');
    return this.hour.apply(this, arguments);
  };

  TimePicker.prototype.setMinute = function(minute, suppressCallback) {
    deprecatedWarning(this.selector, 'setMinute(minute, suppressCallback)', 'minute(minute, suppressCallback)');
    return this.minute.apply(this, arguments);
  };

  TimePicker.prototype.setSecond = function(second, suppressCallback) {
    deprecatedWarning(this.selector, 'setSecond(second, suppressCallback)', 'second(second, suppressCallback)');
    return this.second.apply(this, arguments);
  };
...
TagInput = (function(superClass) {
  ...
  TagInput.prototype.removeAll = function() {
    hx.deprecatedWarning(this.selector + ': TagInput.removeAll()', 'Use TagInput.remove() instead.');
    return this.remove();
  };
...
(function(){var Modal, getTitleRender, makeButtons, modal_dialog, modal_input,
  extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
  hasProp = {}.hasOwnProperty;
...
modal_dialog = function(title, message, callback, buttons, isClosable, titleClass, icon) {
  var modal, setup;
...
hx.notify.setDefaultTimeout = function(timeout) {
  hx.deprecatedWarning('hx.notify.setDefaultTimeout(timeout)', 'Use hx.notify.defaultTimeout(timeout) instead.');
  return hx.notify.defaultTimeout.apply(this, arguments);
};

hx.getNotificationManager = function() {
  hx.deprecatedWarning('hx.getNotificationManager()', 'Use hx.notify() instead.');
  return hx.notify.apply(this, arguments);
};

hx.getNotificationManager = function() {
  hx.deprecatedWarning('hx.getNotificationManager.setDefaultTimeout(timeout)', 'Use hx.notify.defaultTimeout(timeout) instead.');
  return hx.notify.defaultTimeout.apply(this, arguments);
};
})();
...
Slider = (function(superClass) {
  ...
  function Slider(selector1, options) {
    ...
    if (hx.isString(options)) {
      hx.consoleWarning(selector + ': hx.Slider incorrect value passed into constructor', 'The slider constructor expects an options object as the second parameter but was passed "' + options + '"');
    }
  ...
  Slider.prototype.getValue = function() {
    hx.deprecatedWarning(this.selector + ': Slider.getValue()', 'Use Slider.value() instead.');
    return this.value.apply(this, arguments);
  };

  Slider.prototype.setValue = function(value) {
    hx.deprecatedWarning(this.selector + ': Slider.setValue(value)', 'Use Slider.value(value) instead.');
    return this.value.apply(this, arguments);
  };
...
DateTimePicker = (function(superClass) {
  var deprecatedWarning;

  extend(DateTimePicker, superClass);

  function DateTimePicker(selector1, type, showSeconds) {
    var dtNode, tpNode;
    this.selector = selector1;
    this.type = type;
  ...
  DateTimePicker.prototype.update = function(locale) {
    ...
    return this.datePicker.update(locale);
  };

  deprecatedWarning = function(selector, method, alt) {
    return hx.deprecatedWarning(selector + ": DateTimePicker." + method, "Use DateTimePicker." + alt + " instead.");
  };
  ...
  DateTimePicker.prototype.setDate = function(date, setTime, suppressCallback1) {
    this.suppressCallback = suppressCallback1 != null ? suppressCallback1 : false;
    deprecatedWarning(this.selector, 'setDay(day, suppressCallback)', 'day(day, suppressCallback)');
    return this.date.apply(this, arguments);
  };

  DateTimePicker.prototype.setDay = function(day, suppressCallback) {
    deprecatedWarning(this.selector, 'setDay(day, suppressCallback)', 'day(day, suppressCallback)');
    return this.day.apply(this, arguments);
  };

  DateTimePicker.prototype.setMonth = function(month, suppressCallback) {
    deprecatedWarning(this.selector, 'setMonth(month, suppressCallback)', 'month(month, suppressCallback)');
    return this.month.apply(this, arguments);
  };

  DateTimePicker.prototype.setYear = function(year, suppressCallback) {
    deprecatedWarning(this.selector, 'setYear(year, suppressCallback)', 'year(year, suppressCallback)');
    return this.year.apply(this, arguments);
  };

  DateTimePicker.prototype.setHour = function(hour, suppressCallback) {
    deprecatedWarning(this.selector, 'setHour(hour, suppressCallback)', 'hour(hour, suppressCallback)');
    return this.hour.apply(this, arguments);
  };

  DateTimePicker.prototype.setMinute = function(minute, suppressCallback) {
    deprecatedWarning(this.selector, 'setMinute(minute, suppressCallback)', 'minute(minute, suppressCallback)');
    return this.minute.apply(this, arguments);
  };

  DateTimePicker.prototype.setSecond = function(second, suppressCallback) {
    deprecatedWarning(this.selector, 'setSecond(second, suppressCallback)', 'second(second, suppressCallback)');
    return this.second.apply(this, arguments);
  };
...
Form = (function(superClass) {
  ...
  Form.prototype.fill = function(data) {
    hx.deprecatedWarning(this.selector + ': Form.fill(data)', 'Use Form.data(data) instead.');
    return this.data.apply(this, arguments);
  };

  Form.prototype.getData = function() {
    hx.deprecatedWarning(this.selector + ': Form.getData()', 'Use Form.data() instead.');
    return this.data.apply(this, arguments);
  };
...
Paginator = (function(superClass) {
  ...
  Paginator.prototype.setPage = function(i) {
    hx.deprecatedWarning(this._.selector + ': Paginator.setPage(i)', 'Use Paginator.page(i) instead');
    return this.page.apply(this, arguments);
  };

  Paginator.prototype.getPage = function() {
    hx.deprecatedWarning(this._.selector + ': Paginator.getPage()', 'Use Paginator.page() instead');
    return this.page.apply(this, arguments);
  };
...
UserPreferences = (function(superClass) {
  ...
  UserPreferences.prototype.getPreferences = function(cb) {
    hx.deprecatedWarning('Preferences.getPreferences(cb)', 'Use Preferences.value(cb).');
    return this.value.apply(this, arguments);
  };
...
ProgressBar = (function() {
  ...
  ProgressBar.prototype.setProgress = function(value) {
    hx.deprecatedWarning(this.selector + ': ProgressBar.setProgress(value)', 'Use ProgressBar.value(value) instead.');
    return this.value.apply(this, arguments);
  };

  ProgressBar.prototype.getProgress = function() {
    hx.deprecatedWarning(this.selector + ': ProgressBar.getProgress()', 'Use ProgressBar.value() instead.');
    return this.value.apply(this, arguments);
  };
...
TimeSlider = (function(superClass) {
  ...
  TimeSlider.prototype.getValue = function() {
    hx.deprecatedWarning(this.selector + ': TimeSlider.getValue()', 'Use TimeSlider.value() instead.');
    return this.value.apply(this, arguments);
  };

  TimeSlider.prototype.setValue = function(value) {
    hx.deprecatedWarning(this.selector + ': TimeSlider.setValue(value)', 'Use TimeSlider.value(value) instead.');
    return this.value.apply(this, arguments);
  };
