    ...
    if (this.visible !== true) {
      ...
      if (animate) {
        ...
        content.morph()["with"]('expandv', 100).and('fadein', 100).then(function() {
          self.emit('showend');
          return self.emit('changeend', true);
        }).go(true);
    ...
    if (this.visible !== false) {
      ...
      if (animate) {
        ...
        this.selection.select('.hx-collapsible-content').morph()["with"]('fadeout', 100).and('collapsev', 100).then(function() {
          self.emit('hideend');
          return self.emit('changeend', false);
        }).go(true);
...
initializeToggleButtons('.hx-btn-toggle');
})();
(function(){var Menu, MenuItem, addItem, checkEvent, dealWithEvent, dropdownContent, emitItem, getAllItems, moveSelectionDown, moveSelectionUp, setActive, setupInner, setupItems, toggleCollapsible,
  extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
  hasProp = {}.hasOwnProperty;
...
getAllItems = function(menu) {
  ...
  pushItems = function(arr, parentIndex) {
    return arr.forEach(function(d, i) {
      ...
      allItems.push(d);
      if (d.menuItems) {
        return pushItems(d.menuItems, i);
      }
    });
  };
  pushItems(menu.menuItems);
  return allItems;
};
...
setActive = function(menu, pos, up, click) {
  ...
  if ((selectedItem = allItems != null ? allItems[menu.cursorPos] : void 0) != null) {
    emitItem(menu, selectedItem, 'activeset', click ? 'click' : 'arrow');
    if (click) {
      return emitItem(menu, selectedItem, 'select', 'click');
    }
  }
};
...
dealWithEvent = function(menu, force, eventType) {
  ...
  if ((force != null) && !force && ((selectedItem != null ? (ref = selectedItem.parent) != null ? ref.collapsible : void 0 : void 0) != null)) {
    ...
    return emitItem(menu, selectedItem, 'select', eventType);
  }
};
...
Menu = (function(superClass) {
  ...
  function Menu(selector, align, mode, ddClass) {
    ...
    this.dropdown = new hx.Dropdown(this.selector, dropdownContent(function() {
      return self.menuItems;
    }), mode, align, void 0, true, ddClass);
  ...
  Menu.prototype.renderer = function(element, item) {
    return hx.select(element).html(item);
  };
...
DatePicker = (function(superClass) {
  ...
  function DatePicker(selector, options) {
    ...
    if (this.options.selectRange) {
      ...
      this.useInbuilt = (typeof moment === "undefined" || moment === null) && hx.supports('date') && hx.supports('touch');
...
AutoComplete = (function(superClass) {
  ...
  function AutoComplete(selector, data1, options) {
    ...
    if (!hx.isArray(this.data) && !hx.isFunction(this.data)) {
      ...
      hx.select(menu.selector).off('click', 'hx.menu');
...
SideCollapsible = (function(superClass) {
  ...
  SideCollapsible.prototype.show = function(animate) {
      ...
      if (animate) {
        ...
        this.closedHeading.morph()["with"]('fadeout', 100).then((function(_this) {
          return function() {
            ...
            return _this.content.morph()["with"]('expandh', 100).and('fadein', 100).and(function() {
  ...
  SideCollapsible.prototype.hide = function(animate) {
    var self;
    animate = animate != null ? animate : this.options.animate;
    if (this.visible) {
      this.visible = false;
      if (animate) {
        ...
        this.content.morph()["with"]('collapseh', 100).and('fadeout', 100).and((function(_this) {
          ...
          return function() {
            ...
            return _this.closedHeading.morph()["with"]('fadein', 100).go(true);
          };
        })(this)).go(true);
      } else {
        this.selection.style('width', this.closedSize + 'px');
