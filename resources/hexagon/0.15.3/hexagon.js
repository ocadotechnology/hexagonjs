        ...
        return feed.totalCount(function(totalCount) {
          ...
          return feed.rows({
            ...
            if (headers.some(function(header) {
              ...
              sortColPickerRenderer = function(element, data) {
                if (data.details) {
                  return getColumnOption('headerCellRenderer', data.value)(element, data.details);
                } else {
                  return hx.select(element).text('No sort');
                }
              };
              _this._.sortColPicker.renderer(sortColPickerRenderer).items([
                {
                  details: void 0,
                  id: void 0
                }
            ...
            if (filteredCount === void 0 || filteredCount > 0) {
              rows.forEach(function(row, rowIndex) {
                ...
                for (columnIndex = m = 0, len = ref2.length; m < len; columnIndex = ++m) {
                  ...
                  getColumnOption('headerCellRenderer', headers[columnIndex].id)(cellDiv.append('div')["class"]('hx-data-table-cell-key').node(), headers[columnIndex]);
                  results.push(getColumnOption('cellRenderer', headers[columnIndex].id)(cellDiv.append('div')["class"]('hx-data-table-cell-value').node(), cell, row));
                }
                return results;
              });
            } else {
...
Table = (function(superClass) {
  ...
  render = function(table, callback) {
    ...
    renderMobilePage = function(next) {
      var cellRenderer, defaultCellRenderer, k, lowerCaseCellRenderers, ref, renderer, responsiveCellEnter, responsiveCellUpdate, responsiveNoDataUpdate, rowEnter, rowUpdate, rows, v;
      defaultCellRenderer = table.options.defaultCellRenderer || function(d, e, i) {
        return this.text(d);
      };
      lowerCaseCellRenderers = {};
