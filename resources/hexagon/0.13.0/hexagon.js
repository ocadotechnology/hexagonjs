...
hx.merge = function() {
  ...
  if (hx.isBoolean(objects[0])) {
    if (objects[0]) {
      hx.deprecatedWarning("Using hx.merge with boolean first parameter is deprecated. For hx.merge(true, objects...) simply use hx.merge(objects...)");
    } else {
      hx.deprecatedWarning("Using hx.merge with boolean first parameter is deprecated. For hx.merge(true, objects...) use hx.merge.defined(objects...)");
    }
    return hx_merge(true, objects[0], objects.slice(1));
  } else {
...
hx.shallowMerge = function() {
  ...
  if (hx.isBoolean(objects[0])) {
    if (objects[0]) {
      hx.deprecatedWarning("Using hx.shallowMerge with boolean first parameter is deprecated. For hx.shallowMerge(true, objects...) simply use hx.shallowMerge(objects...)");
    } else {
      hx.deprecatedWarning("Using hx.shallowMerge with boolean first parameter is deprecated. For hx.shallowMerge(true, objects...) use hx.shallowMerge.defined(objects...)");
    }
    return hx_merge(false, objects[0], objects.slice(1));
  } else {
...
Selection = (function() {
    ...
    if (arguments.length === 2) {
      ...
      if (namespace) {
        return reformed(this.singleSelection, (function() {
          ...
          for (k = 0, len1 = ref1.length; k < len1; k++) {
            node = ref1[k];
            results.push(node.getAttributeNS(namespace, attr));
          }
          return results;
        }).call(this));
      } else {
        return reformed(this.singleSelection, (function() {
          ...
          for (k = 0, len1 = ref1.length; k < len1; k++) {
            node = ref1[k];
            results.push(node.getAttribute(attr));
          }
          return results;
        }).call(this));
      }
  ...
  Selection.prototype.on = function(name, namespace, f, retain) {
    ...
    if (retain != null) {
      hx.deprecatedWarning('The retain parameter of selection.on(name, function, retain) has been deprecated.', 'Use selection.on(name, namespace, function) to add multiple event listeners to a selection.');
    }
    if (namespace === 'default') {
      namespace = 'hx.selection';
    }
...
Dropdown = (function(superClass) {
  ...
  function Dropdown(selector, dropdownContent, options) {
    ...
    if (hx.isString(options) || arguments.length > 3) {
      hx.deprecatedWarning('hx.Dropdown(selector, dropdownContent, mode, align, spacing, matchWidth, ddClass)', 'Use hx.Dropdown(selector, dropdownContent, options)');
      options = {
        mode: arguments[2] != null ? arguments[2] : void 0,
        align: arguments[3] != null ? arguments[3] : void 0,
        spacing: arguments[4] != null ? arguments[4] : void 0,
        matchWidth: arguments[5] != null ? arguments[5] : void 0,
        ddClass: arguments[6] != null ? arguments[6] : void 0
      };
    }
  ...
  Dropdown.prototype.show = function(cb) {
    var bodyDiff, checkOverlap, ddHeight, ddMaxHeight, dropdownRect, horizontalOverlap, horizontalPos, horizontalWindow, invertY, movedVertical, node, parentFixed, parentZIndex, rect, scrolbarCounter, scrollbarWidth, verticalOverlap, verticalPos, verticalWindow, yPos;
    if (!this.dropdown) {
      switch (false) {
    ...
    if (!this.visible && this.dropdown) {
      ...
      scrolbarCounter = ddMaxHeight > 0 && dropdownRect.height >= this.dropdown.style('max-height').replace('px', '') ? scrollbarWidth : 0;
      this.dropdown.style('top', 'auto').style(yPos, verticalPos + 'px').style('left', horizontalPos + 'px').style('width', dropdownRect.width + scrolbarCounter + 'px');
...
Collapsible = (function(superClass) {
  ...
  function Collapsible(selector, options) {
    ...
    if (hx.isFunction(options) || arguments.length > 2) {
      hx.deprecatedWarning('hx.Collapsible(selector, lazyContent, visible, addIcon)', 'Use hx.Collapsible(selector, options) instead');
      options = {
        lazyContent: arguments[1],
        visible: arguments[2],
        addIcon: arguments[3]
      };
    }
...
hx.initialiseCollapsibles = function(selector, lazyContent) {
  hx.deprecatedWarning('hx.initialiseCollapsibles(selector, lazyContent)', 'Use hx.initializeCollapsibles(selector, options) instead.');
  return hx.initializeCollapsibles(selector, {
    lazyContent: lazyContent
  });
};
})();
(function(){var ToggleButton, initializeToggleButtons,
  extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
  hasProp = {}.hasOwnProperty;
...
initializeToggleButtons = function(selection) {
  var arr;
  hx.deprecatedWarning('hx.initializeToggleButtons(selection)', 'Toggle buttons should be initialized individually with hx.ToggleButton instead.');
  arr = [];
  hx.selectAll(selection).map(function(d) {
    return new hx.ToggleButton(d);
  });
  return arr;
};

hx.initializeToggleButtons = initializeToggleButtons;

hx.initialiseToggleButtons = function(selection) {
  hx.deprecatedWarning('hx.initialiseToggleButtons(selection)', 'Use hx.initializeToggleButtons(selection) instead (American spelling)');
  return initializeToggleButtons(selection);
};
})();
...
Menu = (function(superClass) {
  ...
  function Menu(selector, options) {
    var cls, colorClass, ddClass, dropdownContent, isInput, j, len, renderer, selection, self, targetElem;
    this.selector = selector;
    Menu.__super__.constructor.apply(this, arguments);
    if (arguments.length > 2 || hx.isString(options)) {
      hx.deprecatedWarning('hx.Menu(selector, align, mode, ddClass)', 'Use hx.Menu(selector, options) instead.');
      options = {
        align: arguments[1],
        mode: arguments[2],
        ddClass: arguments[3]
    ...
    Object.defineProperty(this, 'renderer', {
      set: function(f) {
        hx.deprecatedWarning('Overriding hx.Menu.renderer has been deprecated', 'Use hx.Menu.renderer(f) to set the renderer or define the renderer as an option in the constructor.');
        return self.options.renderer = f;
      },
      get: function() {
        return renderer;
      }
  ...
  Menu.prototype.clearItems = function() {
    hx.deprecatedWarning('hx.Menu.clearItems()', 'Use hx.Menu.items([]) instead.');
    return this.items([]);
  };
  ...
  Menu.prototype.render = function(data) {
    hx.deprecatedWarning('Menu.render: The render method has been replaced with .items for more cross module consistency.', 'menu.items(items)');
    this.data = data;
    return this;
  };
...
NumberPicker = (function(superClass) {
  ...
  function NumberPicker(selector, options) {
    ...
    if (hx.isString(options)) {
      hx.deprecatedWarning('hx.NumberPicker(selector, buttonClass)', 'Use hx.NumberPicker(selector, options) instead.');
      options = {
        buttonClass: arguments[1]
      };
    }
    this.options = hx.merge.defined({
      buttonClass: '',
  ...
  NumberPicker.prototype.setMin = function(min) {
    hx.deprecatedWarning('hx.NumberPicker.setMin(min)', 'Use hx.NumberPicker.min(value) instead');
    return this.min(min);
  };

  NumberPicker.prototype.setMax = function(max) {
    hx.deprecatedWarning('hx.NumberPicker.setMax(max)', 'Use hx.NumberPicker.max(value) instead');
    return this.max(max);
  };
...
Select = (function(superClass) {
  ...
  function Select(selector, options) {
    ...
    if ((options != null) && hx.isString(options)) {
      hx.deprecatedWarning('hx.Select(selector, ddClass)', 'Use hx.Select(selector, options) instead');
      options = {
        ddClass: options
      };
    }
    ...
    self = this;
    Object.defineProperty(this, 'selectItems', {
      get: function() {
        hx.deprecatedWarning('Getting Select.selectItems', 'Use items() instead.');
        return self.items();
      }
    });
    this.current = void 0;
    button = this.selection.classed('hx-select', true);
...
DatePicker = (function(superClass) {
  ...
  function DatePicker(selector, options) {
    ...
    if (typeof options === 'string' || arguments.length > 2) {
      ...
      options = {
        type: arguments[1],
        closeOnSelect: arguments[2],
        selectRange: arguments[3]
      };
    }
    this.options = hx.merge.defined({
      type: 'calendar',
  ...
  DatePicker.prototype.date = function(date) {
    ...
    if (date != null) {
      ...
      _.startDate = date;
      if (arguments.length > 1) {
        hx.deprecatedWarning('datepicker.date(date, dontSetupInput, suppressCallback)', 'Use datepicker.date(date) instead.');
        if (arguments[2] != null) {
          hx.deprecatedWarning('Suppressing the callback with datepicker.date(date, dontSetupInput, suppressCallback)', 'Use datepicker.suppressed(\'change\', true) to suppress the change event instead (extends event emitter)');
          if (arguments[2] === true) {
            this.suppressed('change', true);
          }
        }
      }
  ...
  DatePicker.prototype.day = function(day) {
    ...
    if (day != null) {
      ...
      if (arguments[1] != null) {
        hx.deprecatedWarning('Suppressing the callback with datepicker.day(date, suppressCallback)', 'Use datepicker.suppressed(\'change\', true) to suppress the change event instead (extends event emitter)');
        if (arguments[1] === true) {
          this.suppressed('change', true);
        }
      }
  ...
  DatePicker.prototype.month = function(month) {
    ...
    if (month != null) {
      ...
      if (arguments[1] != null) {
        hx.deprecatedWarning('Suppressing the callback with datepicker.month(date, suppressCallback)', 'Use datepicker.suppressed(\'change\', true) to suppress the change event instead (extends event emitter)');
        if (arguments[1] === true) {
          this.suppressed('change', true);
        }
      }
  ...
  DatePicker.prototype.year = function(year) {
    ...
    if (year != null) {
      ...
      if (arguments[1] != null) {
        hx.deprecatedWarning('Suppressing the callback with datepicker.year(date, suppressCallback)', 'Use datepicker.suppressed(\'change\', true) to suppress the change event instead (extends event emitter)');
        if (arguments[1] === true) {
          this.suppressed('change', true);
        }
      }
  ...
  DatePicker.prototype.range = function(range) {
    ...
    if (this.options.selectRange) {
      ...
      if (!_.getterAdded) {
        _.getterAdded = true;
        Object.defineProperty(_.range, 'count', {
          get: function() {
            hx.deprecatedWarning('datepicker.range().count', 'This property will be removed - use  1 + Math.floor((range.end.getTime() - range.start.getTime())/86400000) to get the number of days in the range');
            return 1 + Math.floor((_.endDate.getTime() - _.startDate.getTime()) / 86400000);
          }
        });
      }
      if (arguments.length > 0) {
        if (range instanceof Date || range === void 0 || arguments.length > 1) {
          hx.deprecatedWarning('datepicker.range(date1, date2, dontSetupInput, suppressCallback)', 'Use datepicker.range(range) instead.');
          range = {
            start: arguments[0] || _.startDate,
            end: arguments[1] || _.endDate
          };
          if (arguments[3] === true) {
            this.suppressed('change', true);
          }
        ...
        updateDatepicker(this);
        _.range.start = _.startDate;
        _.range.end = _.endDate;
        return this;
      } else {
        return _.range;
      }
  ...
  DatePicker.prototype.validRange = function(validRange) {
    ...
    if (arguments.length > 0) {
      if (validRange instanceof Date || validRange === void 0) {
        hx.deprecatedWarning('datepicker.validRange(start, end, suppressCallback)', 'Use datepicker.validRange(validRange)');
        validRange = {
          start: arguments[0],
          end: arguments[1]
        };
        ...
        hx.deprecatedWarning('Suppressing the callback with datepicker.validRange(validRange, suppressCallback)', 'Use datepicker.suppressed(\'change\', true) to suppress the change event instead (extends event emitter)');
        if (arguments[1] === true) {
          this.suppressed('change', true);
        }
      }
  ...
  DatePicker.prototype.update = function(locale) {
    hx.deprecatedWarning('hx.DatePicker.update(locale)', 'Use hx.DatePicker.locale(locale) instead.');
    if ((typeof moment !== "undefined" && moment !== null) && (locale == null)) {
  ...
  DatePicker.prototype.showMonth = function(month, year) {
    hx.deprecatedWarning('datepicker.showMonth has been deprecated', 'Use datepicker.visibleMonth instead.');
    return this.visibleMonth(month, year);
  };

  DatePicker.prototype.showDropdown = function() {
    hx.deprecatedWarning('datepicker.showDropdown has been deprecated', 'Use datepicker.show instead.');
    return this.show();
  };

  DatePicker.prototype.hideDropdown = function() {
    hx.deprecatedWarning('datepicker.hideDropdown has been deprecated', 'Use datepicker.hide instead.');
    return this.hide();
  };

  DatePicker.prototype.addDays = function(days) {
    hx.deprecatedWarning('datepicker.addDays(days)', 'use datepicker.day(datepicker.day() + days) instead');
    this.day(this.day() + days);
    return this;
  };

  DatePicker.prototype.addMonths = function(months) {
    hx.deprecatedWarning('datepicker.addMonths', 'use datepicker.month(datepicker.month() + months) instead');
    this.month(this.month() + months);
    return this;
  };

  DatePicker.prototype.addYears = function(years) {
    hx.deprecatedWarning('datepicker.addYears', 'use datepicker.year(datepicker.year() + years) instead');
...
TimePicker = (function(superClass) {
  ...
  function TimePicker(selector, options) {
    ...
    if (hx.isBoolean(options) || arguments.length > 2) {
      hx.deprecatedWarning('hx.TimePicker(selector, showSeconds, buttonClass)', 'Use hx.TimePicker(selector, options) instead.');
      options = {
        showSeconds: arguments[1],
        buttonClass: arguments[2]
      };
    }
  ...
  TimePicker.prototype.date = function(date, retainTime) {
    ...
    if (arguments.length > 0 && (date != null)) {
      ...
      _.selectedDate = date;
      if (arguments[2] != null) {
        hx.deprecatedWarning('Suppressing the callback with timepicker.date(date, retainTime, suppressCallback)', 'Use timepicker.suppressed(\'change\', true) to suppress the change event instead (extends event emitter)');
        if (arguments[2] === true) {
          this.suppressed('change', true);
        }
      }
  ...
  TimePicker.prototype.hour = function(hour) {
    ...
    if (arguments.length > 0 && (hour != null)) {
      ...
      if (arguments[1] != null) {
        hx.deprecatedWarning('Suppressing the callback with timepicker.hour(hour, suppressCallback)', 'Use timepicker.suppressed(\'change\', true) to suppress the change event instead (extends event emitter)');
        if (arguments[1] === true) {
          this.suppressed('change', true);
        }
      }
  ...
  TimePicker.prototype.minute = function(minute) {
    ...
    if (arguments.length > 0 && (minute != null)) {
      ...
      if (arguments[1] != null) {
        hx.deprecatedWarning('Suppressing the callback with timepicker.minute(minute, suppressCallback)', 'Use timepicker.suppressed(\'change\', true) to suppress the change event instead (extends event emitter)');
        if (arguments[1] === true) {
          this.suppressed('change', true);
        }
      }
  ...
  TimePicker.prototype.second = function(second) {
    ...
    if (arguments.length > 0 && (second != null)) {
      ...
      if (arguments[1] != null) {
        hx.deprecatedWarning('Suppressing the callback with timepicker.second(second, suppressCallback)', 'Use timepicker.suppressed(\'change\', true) to suppress the change event instead (extends event emitter)');
        if (arguments[1] === true) {
          this.suppressed('change', true);
        }
      }
  ...
  TimePicker.prototype.addHours = function(hours) {
    hx.deprecatedWarning('timepicker.addHours', 'use timepicker.hours to get and set the hours value');
    this.hour(this.hour() + hours);
    return this;
  };

  TimePicker.prototype.addMinutes = function(minutes) {
    hx.deprecatedWarning('timepicker.addMinutes', 'use timepicker.minutes to get and set the minutes value');
    this.minute(this.minute() + minutes);
    return this;
  };

  TimePicker.prototype.addSeconds = function(seconds) {
    hx.deprecatedWarning('timepicker.addSeconds', 'use timepicker.seconds to get and set the seconds value');
  ...
  TimePicker.prototype.update = function(locale) {
    hx.deprecatedWarning('hx.TimePicker.update(locale)', 'Use hx.TimePicker.locale(locale) instead.');
    if ((typeof moment !== "undefined" && moment !== null) && (locale == null)) {
      locale = moment.locale();
    }
    this.locale(locale);
...
TagInput = (function(superClass) {
  ...
  function TagInput(selector, options) {
    ...
    if (hx.isFunction(options) || arguments.length > 2) {
      hx.deprecatedWarning('hx.TagInput(selector, classifier, validator)', 'Use hx.TagInput(selector, options) instead');
      options = {
        classifier: arguments[1] != null ? arguments[1] : void 0,
        validator: arguments[2] != null ? arguments[2] : void 0
      };
    }
    _ = this._ = {};
    this.options = hx.merge.defined({
  ...
  TagInput.prototype.tags = function(tags, cssclass) {
    hx.deprecatedWarning('hx.TagInput.tags', 'Use hx.TagInput.items instead');
...
MorphSection = (function(superClass) {
  ...
  function MorphSection(selector1, options) {
    ...
    hx.component.register(this.selector, this);
    if (hx.isBoolean(options)) {
      hx.deprecatedWarning('hx.MorphSection(selector, animate)', 'Use hx.MorphSection(selector, options) instead.');
      options = {
        animate: arguments[1]
      };
    }
...
renderStickyHeaders = function() {
  ...
  if (this.options.stickTableHead) {
    ...
    this.table.select('thead').selectAll('tr').each(function(rowNode) {
      var newRowNode;
      newRowNode = headerTableContent.append('tr');
      return hx.select(rowNode).selectAll('th, td').each(function(cellNode) {
  ...
  if (this.options.stickFirstColumn) {
    ...
    this.table.select('tbody').selectAll('tr').select('th, td').each(function(node) {
      return fixSizes(node, function(newNode) {
...
StickyTableHeaders = (function(superClass) {
  ...
  function StickyTableHeaders(selector, options) {
    ...
    if (this.options.stickFirstColumn && this.options.stickTableHead) {
      ...
      this.table.select('thead').selectAll('tr').each(function(rowNode) {
        return topLeftTable.append('tr').append(hx.select(rowNode).select('th, td').node().cloneNode(true));
      });
    }
...
Modal = (function(superClass) {
  ...
  function Modal(title1, setup1, options) {
    ...
    if (hx.isBoolean(options)) {
      hx.deprecatedWarning('hx.Modal(title, setup, isClosable)', 'Use hx.modal(title, setup, options) instead.');
      options = {
        isClosable: arguments[2]
      };
    }
    self = this;
    Object.defineProperty(this, 'setupTitlebar', {
      set: function(val) {
        hx.deprecatedWarning('Setting modal.setupTitlebar', 'Use modal.options.titlebarRenderer instead');
        return self.options.titlebarRenderer = val;
      },
      get: function() {
        hx.deprecatedWarning('Getting modal.setupTitlebar', 'Use modal.options.titlebarRenderer instead.');
        return self.options.titlebarRenderer;
      }
    });
    this.options = hx.merge({
      isClosable: true,
...
modalDialog = function(title, message, callback, options) {
  var modal, setup;
  if (hx.isArray(options) || arguments.length > 4) {
    hx.deprecatedWarning('hx.modal.dialog(title, message, callback, buttons, isClosable, titleClass, icon)', 'Use hx.modal.dialog(title, message, callback, options) instead.');
    options = {
      buttons: arguments[3] != null ? arguments[3] : void 0,
      isClosable: arguments[4] != null ? arguments[4] : void 0,
      titleClass: arguments[5] != null ? arguments[5] : void 0,
      icon: arguments[6] != null ? arguments[6] : void 0
    };
  }
  options = hx.merge.defined({
    callback: void 0,
...
modalInput = function(title, message, callback, options) {
  var modal, setup;
  if (hx.isBoolean(options) || arguments.length > 3) {
    hx.deprecatedWarning('hx.modal.input(title, message, callback, isClosable)', 'Use hx.modal.dialog(title, message, callback, options) instead.');
    options = {
      isClosable: arguments[3] != null ? arguments[3] : void 0
    };
  }
  options = hx.merge.defined({
    isClosable: void 0,
...
redraw = function(manager) {
  var view;
  view = manager.notificationContainer.view('.hx-notification');
  view.enter(function(d) {
    var selection;
    selection = this.append('div');
    selection["class"]('hx-notification hx-group hx-horizontal ' + d.options.cssclass).each(function(node) {
...
NotificationManager = (function() {
  ...
  function NotificationManager(selector) {
    ...
    this.currentId = 0;
    this.notifications = [];
    this.notificationContainer = hx.select(selector).append('div')["class"]('hx-notification-container');
    this._ = {
      defaultTimeout: 5
    };
  }
  ...
  NotificationManager.prototype.permanent = function(message, icon, cssclass) {
    hx.deprecatedWarning('hx.notify().permanent(message, icon, cssclass)', 'Use hx.notify(message, options) instead.');
  ...
  NotificationManager.prototype.temporary = function(message, icon, cssclass, timeout) {
    if (timeout == null) {
      timeout = this._.defaultTimeout;
    }
    hx.deprecatedWarning('hx.notify().temporary(message, icon, cssclass, timeout)', 'Use hx.notify(message, options) instead.');
    return this.notify(message, {
      icon: icon,
      cssclass: cssclass,
      timeout: timeout
  ...
  contextMessage = function(manager, message, defaults, options, deprecatedType) {
    if (!hx.isObject(options)) {
      hx.deprecatedWarning('hx.notify().' + deprecatedType + '(message, timeout)', 'Use hx.notify.' + deprecatedType + '(message, options) instead.');
      options = {
        timeout: arguments[3]
      };
    }
    options = hx.merge(defaults, options);
    return manager.notify(message, options);
  };
  ...
  NotificationManager.prototype.info = function(message, options) {
    ...
    return contextMessage(this, message, defaults, options, 'info');

    /* XXX: Remove contextMessage function when removing deprecated methods.
  ...
  NotificationManager.prototype.warning = function(message, options) {
    ...
    return contextMessage(this, message, defaults, options, 'warning');
  ...
  NotificationManager.prototype.negative = function(message, options) {
    ...
    return contextMessage(this, message, defaults, options, 'negative');
  ...
  NotificationManager.prototype.positive = function(message, options) {
    ...
    return contextMessage(this, message, defaults, options, 'positive');
...
hx.notify = function(message, options) {
  if (arguments.length === 0) {
    hx.deprecatedWarning('hx.notify()', 'Use hx.notify instead');
...
hx.notify.defaultTimeout = function(timeout) {
  return inbuiltNotificationManager.defaultTimeout(timeout);
};
})();
...
validateForm = function(form, options) {
  ...
  if (hx.isBoolean(options || arguments.length > 2)) {
    hx.deprecatedWarning("validateForm(form, showMessage) has been replaced with validateForm(form, options)");
    if (hx.isBoolean(options)) {
      options = {
        showMessage: options
      };
...
TitleBar = (function() {
  ...
  TitleBar.prototype.setActive = function(id) {
    hx.deprecatedWarning('hx.TitleBar.setActive(id)', 'Use hx.TitleBar.active(id) instead.');
    return this.active(id);
  };

  TitleBar.prototype.setContextClass = function(cls) {
    hx.deprecatedWarning('hx.TitleBar.setContextClass(class)', 'Use hx.TitleBar.contextClass(class) instead.');
    return this.contextClass.apply(this, arguments);
  };
...
renderValues = function() {
  var _, endValue, height, node, points, startValue, val;
  _ = this._;
...
Slider = (function(superClass) {
  ...
  function Slider(selector, options) {
    ...
    if (options.render != null) {
      hx.deprecatedWarning('hx.Slider options.render', 'Use options.renderer instead.');
  ...
  Slider.prototype.setDiscreteValues = function(array, render) {
    hx.deprecatedWarning('Slider.setDiscreteValues(array, render)', 'Use Slider.discreteValues(array, render) instead.');
    return this.discreteValues(array, render);
  };
  ...
  Slider.prototype.value = function(value) {
    ...
    if (arguments.length > 0) {
      ...
      if (this.options.type === 'range') {
        if ((value.startValue != null) || (value.endValue != null)) {
          hx.deprecatedWarning('hx.TimeSlider.value(obj): obj.startValue and obj.endValue have been deprecated', 'Use obj.start and obj.end instead');
          if (value.startValue != null) {
            this.values.start = clamp(value.startValue);
          }
          if (value.endValue != null) {
            this.values.end = clamp(value.endValue);
          }
        }
        if (value.start != null) {
      ...
      if (this.options.type === 'range') {
        res = {};
        if (this.values.start != null) {
          res.start = this.values.start;
        }
        if (this.values.end != null) {
          res.end = this.values.end;
        }
        Object.defineProperty(res, "startValue", {
          get: (function(_this) {
            return function() {
              hx.deprecatedWarning('timeSlider.value().startValue', 'Use timeSlider.value().start instead.');
              return _this.values.start;
            };
          })(this)
        });
        Object.defineProperty(res, "endValue", {
          get: (function(_this) {
            return function() {
              hx.deprecatedWarning('timeSlider.value().endValue', 'Use timeSlider.value().end instead.');
              return _this.values.end;
            };
          })(this)
        });
        return res;
...
ColorPicker = (function(superClass) {
  ...
  function ColorPicker(selector, options) {
    var _, buildDropdown, self;
    ColorPicker.__super__.constructor.apply(this, arguments);
    if (hx.isString(options) || arguments.length > 2) {
      hx.deprecatedWarning('hx.ColorPicker(selector, startColor, showInputs, align)', 'Use hx.ColorPicker(selector, options) instead.');
      options = {
        startColor: arguments[1] != null ? arguments[1] : void 0,
        showInputs: arguments[2] != null ? arguments[2] : void 0,
        align: arguments[3] != null ? arguments[3] : void 0
      };
    }
    this.options = hx.merge.defined({
    ...
    self = this;
    Object.defineProperty(this, 'showInputs', {
      set: function(val) {
        hx.deprecatedWarning('Setting hx.ColorPicker.showInputs', 'Use hx.ColorPicker.options.showInputs instead.');
        return self.options.showInputs = val;
      }
    });
    Object.defineProperty(this, 'currentColor', {
      set: function(val) {
        hx.deprecatedWarning('Setting hx.ColorPicker.currentColor', 'Use hx.ColorPicker.value(color) instead');
        return self.value(val);
      },
      get: function() {
        hx.deprecatedWarning('Getting hx.ColorPicker.currentColor', 'Use hx.ColorPicker.value() instead.');
        return hx.color(self.value());
      }
    });
    hx.component.register(selector, this);
    this._ = {};
...
Crumbtrail = (function() {
  ...
  Crumbtrail.prototype.render = function(data, renderer, separator) {
    ...
    hx.deprecatedWarning('hx.Crumbtrail.render(data, renderer, separator)', 'Use renderer(render) and items(data) or set up the renderer and items in the options when creating the crumbtrail.');
...
DateTimePicker = (function(superClass) {
  ...
  function DateTimePicker(selector, options) {
    ...
    if (hx.isString(options) || arguments.length > 2) {
      hx.deprecatedWarning('hx.DateTimePicker(selector, type, showSeconds)', 'Use hx.DateTimePicker(selector, options) instead.');
      options = {
        datePickerOptions: {
          type: arguments[1]
        },
        timePickerOptions: {
          showSeconds: arguments[2]
        }
      };
    }
    this.options = hx.merge({
    ...
    this.datePicker.on('change', 'hx.date-time-picker', (function(_this) {
      return function() {
        ...
        return _this.suppressed('change', false);
      };
    })(this));
  ...
  DateTimePicker.prototype.date = function(val, retainTime) {
    if (arguments.length > 0) {
      if (arguments[2] != null) {
        hx.deprecatedWarning('Suppressing the callback with datetimepicker.date(date, retainTime, suppressCallback)', 'Use datetimepicker.suppressed(\'change\', true) to suppress the change event instead (extends event emitter)');
        if (arguments[2] === true) {
          this.suppressed('change', true);
        }
      }
  ...
  DateTimePicker.prototype.year = function(val) {
    if (arguments.length > 0) {
      if (arguments[1] != null) {
        hx.deprecatedWarning('Suppressing the callback with datetimepicker.year(year, suppressCallback)', 'Use datetimepicker.suppressed(\'change\', true) to suppress the change event instead (extends event emitter)');
        if (arguments[1] === true) {
          this.suppressed('change', true);
        }
      }
  ...
  DateTimePicker.prototype.month = function(val) {
    if (arguments.length > 0) {
      if (arguments[1] != null) {
        hx.deprecatedWarning('Suppressing the callback with datetimepicker.month(month, suppressCallback)', 'Use datetimepicker.suppressed(\'change\', true) to suppress the change event instead (extends event emitter)');
        if (arguments[1] === true) {
          this.suppressed('change', true);
        }
      }
  ...
  DateTimePicker.prototype.day = function(val) {
    if (arguments.length > 0) {
      if (arguments[1] != null) {
        hx.deprecatedWarning('Suppressing the callback with datetimepicker.day(day, suppressCallback)', 'Use datetimepicker.suppressed(\'change\', true) to suppress the change event instead (extends event emitter)');
        if (arguments[1] === true) {
          this.suppressed('change', true);
        }
      }
  ...
  DateTimePicker.prototype.hour = function(val) {
    if (arguments.length > 0) {
      if (arguments[1] != null) {
        hx.deprecatedWarning('Suppressing the callback with datetimepicker.hour(hour, suppressCallback)', 'Use datetimepicker.suppressed(\'change\', true) to suppress the change event instead (extends event emitter)');
        if (arguments[1] === true) {
          this.suppressed('change', true);
        }
      }
  ...
  DateTimePicker.prototype.minute = function(val) {
    if (arguments.length > 0) {
      if (arguments[1] != null) {
        hx.deprecatedWarning('Suppressing the callback with datetimepicker.minute(minute, suppressCallback)', 'Use datetimepicker.suppressed(\'change\', true) to suppress the change event instead (extends event emitter)');
        if (arguments[1] === true) {
          this.suppressed('change', true);
        }
      }
  ...
  DateTimePicker.prototype.second = function(val) {
    if (arguments.length > 0) {
      if (arguments[1] != null) {
        hx.deprecatedWarning('Suppressing the callback with datetimepicker.second(second, suppressCallback)', 'Use datetimepicker.suppressed(\'change\', true) to suppress the change event instead (extends event emitter)');
        if (arguments[1] === true) {
          this.suppressed('change', true);
        }
      }
  ...
  DateTimePicker.prototype.update = function(locale) {
    hx.deprecatedWarning('hx.DateTimePicker.update(locale)', 'Use hx.DateTimePicker.locale(locale) instead.');
    this.locale(locale);
    return this;
  };

  DateTimePicker.prototype.addDays = function(days) {
    hx.deprecatedWarning('datetimepicker.addDays(days)', 'Use datetimepicker.day(datetimepicker.day() + days) instead');
    this.datePicker.addDays(days);
    return this;
  };

  DateTimePicker.prototype.addMonths = function(months) {
    hx.deprecatedWarning('datetimepicker.addMonths(months)', 'Use datetimepicker.month(datetimepicker.month() + months) instead');
    this.datePicker.addMonths(months);
    return this;
  };

  DateTimePicker.prototype.addYears = function(years) {
    hx.deprecatedWarning('datetimepicker.addYears(years)', 'Use datetimepicker.year(datetimepicker.year() + years) instead');
    this.datePicker.addYears(years);
    return this;
  };

  DateTimePicker.prototype.addHours = function(hours) {
    hx.deprecatedWarning('datetimepicker.addHours(hours)', 'Use datetimepicker.hour(datetimepicker.hour() + hours) instead');
    this.timePicker.addHours(hours);
    return this;
  };

  DateTimePicker.prototype.addMinutes = function(minutes) {
    hx.deprecatedWarning('datetimepicker.addMinutes(minutes)', 'Use datetimepicker.minute(datetimepicker.minute() + minutes) instead');
    this.timePicker.addMinutes(minutes);
    return this;
  };

  DateTimePicker.prototype.addSeconds = function(seconds) {
    hx.deprecatedWarning('datetimepicker.addSeconds(seconds)', 'Use datetimepicker.second(datetimepicker.second() + seconds) instead');
    this.timePicker.addSeconds(seconds);
    return this;
  };
...
Table = (function(superClass) {
  ...
  function Table(selector, options) {
    ...
    _.rowsPerPageSelect = new hx.Select(rowSelectNode, {
    ...
    _.pageSelect = new hx.Select(pageSelectNode, {
  ...
  render = function(table, callback) {
    ...
    updateControls = function(next) {
      ...
      rowsArray = table._.rowsPerPageSelect.selectItems;
...
Form = (function(superClass) {
  ...
  Form.prototype.addDatePicker = function(name, options) {
    ...
    this.add(name, 'datepicker', 'div', function() {
      ...
      if ((options.type != null) || (options.closeOnSelect != null) || (options.selectRange != null)) {
        hx.deprecatedWarning('hx.Form.addDatePicker(name, {type, closeOnSelect, selectRange})', 'Use hx.Form.addDatePicker(name, {datePickerOptions}) to specify the options for the datepicker');
  ...
  Form.prototype.addTimePicker = function(name, options) {
    ...
    this.add(name, 'timepicker', 'div', function() {
      ...
      elem = this.append('div').node();
      if ((options.showSeconds != null) || (options.buttonClass != null)) {
        hx.deprecatedWarning('hx.Form.addTimePicker(name, {showSeconds, buttonClass})', 'Use hx.Form.addTimePicker(name, {timePickerOptions}) to specify the options for the time picker');
  ...
  Form.prototype.addDateTimePicker = function(name, options) {
    ...
    this.add(name, 'datetimepicker', 'div', function() {
      ...
      elem = this.append('div').node();
      if ((options.type != null) || (options.showSeconds != null)) {
        hx.deprecatedWarning('hx.Form.addDateTimePicker(name, {type, showSeconds})', 'Use hx.Form.addDateTimePicker(name, {dateTimePickerOptions}) to specify the options for the date/time picker');
  ...
  Form.prototype.addSubmit = function(text, icon) {
    hx.select(this.selector).append('button').attr('type', 'submit')["class"]('hx-btn hx-positive hx-form-submit').html("<i class=\"" + icon + "\"></i> " + text).on('click', 'hx.form-builder', (function(_this) {
      return function(e) {
        e.preventDefault();
        return _this.submit();
      };
  ...
  Form.prototype.addTagInput = function(name, options) {
    ...
    this.add(name, 'tagInput', 'div', function() {
      ...
      if ((options.classifier != null) || (options.validator != null)) {
        hx.deprecatedWarning('hx.Form.addTagInput(name, {classifier, validator})', 'Use hx.Form.addTagInput(name, {tagInputOptions}) instead.');
      ...
      this.properties.forEach(function(key, it) {
        value = (function() {
          switch (it.type) {
            ...
            case 'tagInput':
              return hx.component(it.extras.componentNode || it.node).tags();
            case 'select':
...
InlineSelect = (function(superClass) {
  ...
  function InlineSelect(selector, options) {
    var contextClass, selectNode, selection;
    this.selector = selector;
    if (hx.isString(options)) {
      hx.deprecatedWarning('hx.InlineSelect(selector, contextClass)', 'Use hx.InlineSelect(selector, options) instead');
    ...
    this.select.menu.dropdown.on('show', 'hx.inline-select', (function(_this) {
      return function() {
...
Paginator = (function(superClass) {
  ...
  Paginator.prototype.setPageCount = function(n) {
    hx.deprecatedWarning('hx.Paginator.setPageCount(value)', 'Use hx.Paginator._.pageCount(value) instead');
    return this.pageCount(n);
  };

  Paginator.prototype.setVisibleCount = function(n) {
    hx.deprecatedWarning('hx.Paginator.setVisibleCount(value)', 'Use hx.Paginator._.visibleCount(value) instead');
...
PivotTable = (function(superClass) {
  ...
  PivotTable.prototype.setData = function(data) {
    hx.deprecatedWarning('hx.PivotTable.setData(data)', 'Use hx.PivotTable.data(data) instead.');
    return this.data(data);
  };
...
Preferences = (function(superClass) {
  ...
  Preferences.prototype.locale = function(locale) {
    if (arguments.length > 0) {
      if (localeList.some(function(l) {
        return l.value === locale;
      })) {
        this._.preferences['locale'] = locale;
...
searchDOM = function(selector, string, callback, options) {
  ...
  hideAll = function(cb) {
    root.selectAll('.hx-opened').each(function(elem) {
      var ref;
      return (ref = hx.component(elem)) != null ? ref.hide(false) : void 0;
    });
    return typeof cb === "function" ? cb() : void 0;
  };
...
Sidebar = (function(superClass) {
  ...
  function Sidebar(selector, options) {
    ...
    hx.component.register(selector, this);
    if (hx.isString(options) || arguments.length > 2) {
      hx.deprecatedWarning('hx.Sidebar(selector, headerSelector, contentSelector, autoAddSidebarClass)', 'Use hx.Sidebar(selector, options) instead.');
      options = {
        headerSelector: arguments[1] != null ? arguments[1] : void 0,
        contentSelector: arguments[2] != null ? arguments[2] : void 0,
        autoAddSidebarClass: arguments[3] != null ? arguments[3] : void 0
      };
    }
    options = hx.merge.defined({
...
Tabs = (function(superClass) {
  ...
  function Tabs(selector) {
    ...
    hx.select(this.selector).selectAll('.hx-tab').each(function(node, i) {
      return hx.select(node).on('click', 'hx.tabs', function() {
...
TimeSlider = (function(superClass) {
  ...
  function TimeSlider(selector, opts) {
    var max, min, options, ref, start;
    if (opts == null) {
      opts = {};
    }
    if (((ref = opts.discreteValues) != null ? ref.length : void 0) > 0) {
  ...
  TimeSlider.prototype.valueToDate = function(value) {
    hx.deprecatedWarning('timeslider.valueToDate(date)', 'use new Date(value) instead');
  ...
  TimeSlider.prototype.value = function(value) {
    ...
    if (arguments.length > 0) {
      if (this.options.type === 'range') {
        if ((value.startValue != null) || (value.endValue != null)) {
          hx.deprecatedWarning('hx.TimeSlider.value(obj): obj.startValue and obj.endValue have been deprecated', 'Use obj.start and obj.end instead');
          start = value.startValue != null ? maybeDateToMillis(value.startValue) : void 0;
          end = value.endValue != null ? maybeDateToMillis(value.endValue) : void 0;
        }
      ...
      if (this.options.type === 'range') {
        ...
        Object.defineProperty(res, "startValue", {
          get: (function(_this) {
            return function() {
              hx.deprecatedWarning('timeSlider.value().startValue', 'Use timeSlider.value().start instead.');
              return new Date(_this.values.start);
            };
          })(this)
        });
        Object.defineProperty(res, "endValue", {
          get: (function(_this) {
            return function() {
              hx.deprecatedWarning('timeSlider.value().endValue', 'Use timeSlider.value().end instead.');
              return new Date(_this.values.end);
            };
          })(this)
        });
        return res;
  ...
  TimeSlider.prototype.setRange = function(startDate, endDate) {
    hx.deprecatedWarning('hx.TimeSlider.setRange(startDate, endDate)', 'Use timeslider.min(startDate) and timeslider.max(endDate) instead');
    this.start = maybeDateToMillis(startDate);
    this.end = maybeDateToMillis(endDate);
    return this;
  };
        ...
        return selection.each(function(node) {
          ...
          if (node !== rootNode) {
            ...
            if (subselection.style('display') !== 'block') {
              ...
              return formatIcon(node.parentNode, iconElement, tree.options.animate);
            }
          }
        });
      } else {
...
Tree = (function() {
  function Tree(selector1, options) {
    var hideDisabledButtons;
    this.selector = selector1;
    hx.component.register(this.selector, this);
    if (typeof options === 'boolean') {
      hx.deprecatedWarning('hx.Tree(selector, hideDisabledButtons)', 'Use hx.Tree(selector, options) instead.');
      hideDisabledButtons = arguments[1];
      options = {
  ...
  Tree.prototype.refresh = function(animate) {
    animate = animate != null ? animate : this.options.animate;
    this.selection.selectAll('.hx-tree-node').each((function(_this) {
      return function(d) {
        return format(_this, d, animate);
      };
    })(this));
    return this;
  };
  ...
  Tree.prototype.render = function(data, renderer) {
    hx.deprecatedWarning('tree.render(data, renderer)', 'Use tree.renderer(render) and tree.items(data) instead or supply a renderer and/or items in the constructor.');
    if (renderer != null) {
      this.renderer(renderer);
    }
    this.items(data);
...
hx.initialiseTrees = function(selector) {
  hx.deprecatedWarning('hx.initialiseTrees', 'Use hx.initializeTrees instead');
  return hx.initializeTrees(selector);
};
})();})();