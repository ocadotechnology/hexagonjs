import { dateTimeLocalizer } from 'date-localizer'
import { format } from 'format'
import { preferences, defaultTimezoneLookup } from 'preferences'
  ...
  describe 'dateTimeLocalizer', ->
    ...
    getHexagonTimeZoneOffset = ->
      ...
      if timezonesOffsetParts
        ...
        throw new Error('Cannot calculate Hexagon internal timezone offset')
