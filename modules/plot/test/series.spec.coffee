...
LineSeries = require('../main/series/line-series')
BandSeries = require('../main/series/band-series')
ScatterSeries = require('../main/series/scatter-series')
BarSeries = require('../main/series/bar-series')
StraightLineSeries = require('../main/series/straight-line-series')
