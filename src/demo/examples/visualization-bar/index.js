...
export default () => {
  ...
  const mocks = [
    ...
    [new VisualizationBar(selectionWithLabels.node(), {
      title: 'With labels content', buffer: 2, value: 5, max: 100, withPercent: true, content: 'Hello world!',
      progressLabel: 'Progress', bufferLabel: 'Buffer Long Text!', balanceLabel: 'Balance'
    }), rand(20)],
  ];
