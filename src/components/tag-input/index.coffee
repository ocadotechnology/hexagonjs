...
import { select, div, span, i } from 'utils/selection'
import { identity, isArray, isFunction, mergeDefined } from 'utils/utils'
...
class TagInput extends EventEmitter
  constructor: (@selector, options) ->
    ...
    if @options.autocompleteData?
      ...
      inputMap = @_.autocomplete.options?.inputMap || identity
