...
EventEmitter = (function() {
  ...
  EventEmitter.prototype.off = function(name, namespace, callback) {
    var emitter, _i, _len, _ref, _ref1;
    if (hx.isString(namespace)) {
      if ((_ref = this.emittersMap.get(namespace)) != null) {
        _ref.off(name, callback);
      }
    } else {
      _ref1 = this.emitters.entries();
  ...
  EventEmitter.prototype.deregister = function(name, callback) {
    hx.deprecatedWarning('EventEmitter.deregister has been replaced with EventEmitter.off');
...
getStyles = function(selection, properties) {
  var p, _i, _j, _len, _len1, _results, _results1;
...
hx.morph.register('collapse', function(node, duration) {
  ...
  return hx.animate(node).style('height', '0px', duration).style('padding-top', '0px', duration).style('padding-bottom', '0px', duration).style('margin-top', '0px', duration).style('margin-bottom', '0px', duration).style('width', '0px', duration).style('padding-left', '0px', duration).style('padding-right', '0px', duration).style('margin-left', '0px', duration).style('margin-right', '0px', duration).on('end', function(e) {
    return hx.select(node).style('display', 'none').style('height', '').style('padding-top', '').style('padding-bottom', '').style('margin-top', '').style('margin-bottom', '').style('width', '').style('padding-left', '').style('padding-right', '').style('margin-left', '').style('margin-right', '');
  });
});
...
hx.morph.register('collapsev', function(node, duration) {
  ...
  return hx.animate(node).style('height', '0px', duration).style('padding-top', '0px', duration).style('padding-bottom', '0px', duration).style('margin-top', '0px', duration).style('margin-bottom', '0px', duration).on('end', function(e) {
    return hx.select(node).style('display', 'none').style('height', '').style('padding-top', '').style('padding-bottom', '').style('margin-top', '').style('margin-bottom', '');
  });
});
...
hx.morph.register('collapseh', function(node, duration) {
  ...
  return hx.animate(node).style('width', '0px', duration).style('padding-left', '0px', duration).style('padding-right', '0px', duration).style('margin-left', '0px', duration).style('margin-right', '0px', duration).on('end', function(e) {
    return hx.select(node).style('display', 'none').style('width', '').style('padding-left', '').style('padding-right', '').style('margin-left', '').style('margin-right', '');
  });
});
...
NumberPicker = (function(_super) {
  ...
  checkValue = function(numberPicker) {
    var oldValue, value;
    value = oldValue = numberPicker.getValue();
...
// menu
(function(){
var Menu, MenuItem, checkEvent, dealWithEvent, dropdownContent, getAllItems, moveSelectionDown, moveSelectionUp, setActive, toggleCollapsible,
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
MorphSection = (function(_super) {
  __extends(MorphSection, _super);

  function MorphSection(selector, animate) {
    var selection;
    this.selector = selector;
  ...
  MorphSection.prototype.visible = function(show) {
    ...
    if (show === void 0) {
      ...
      if (this.animate) {
        content.morph().cancelOngoing()["with"]((show ? 'expand-fadein' : 'fadeout-collapse'), show ? 200 : 100).go();
      } else {
...
InlineMorphSection = (function(_super) {
  __extends(InlineMorphSection, _super);
...
Modal = (function(_super) {
  ...
  Modal.prototype.show = function() {
    ...
    if (this.isClosable) {
      title.append('button').attr('type', 'button')["class"]('hx-modal-close hx-btn').html('<i class="fa fa-times"></i>').on('click', (function(_this) {
        return function() {
...
// notify
(function(){
var Notification, NotificationManager, defaultTimeout, inbuiltNotificationManager;
...
hx.getNotificationManager.setDefaultTimeout = function(timeout) {
...
TitleBar = (function() {
  ...
  TitleBar.prototype.setContextClass = function(cls) {
    ...
    _ref = ['hx-positive', 'hx-negative', 'hx-warning', 'hx-info'];
    _results = [];
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      d = _ref[_i];
      _results.push(hx.select(this.selector).select('.hx-titlebar').classed(d, cls === d));
    }
    return _results;
  };
...
Slider = (function(_super) {
  ...
  posToDiscrete = function(pos) {
    var k, space, v, _, _ref;
    _ = this._;
    space = _.discreteSpacing / 2;
    _ref = _.discreteValues;
    for (k in _ref) {
      v = _ref[k];
  ...
  function Slider(selector, options, render) {
    var curr, end, inc, max, mid, min, start, steps, t, value, _, _ref;
    this.selector = selector;
    Slider.__super__.constructor.apply(this, arguments);
    if (typeof options === 'string' || (render != null)) {
      t = options;
      options = {
        type: t
      };
    ...
    this._ = _ = {};
    _.isDiscrete = ((_ref = this.options.discreteValues) != null ? _ref.length : void 0) > 0 || (this.options.step != null);
    _.container = hx.select(this.selector).classed('hx-slider', true).append('div').classed('hx-slider-inner', true).classed('hx-slider-double', this.options.type === 'range').classed('hx-slider-discrete', _.isDiscrete).on('pointerdown', (function(_this) {
      return function(e) {
        _.mouseDown = true;
        _this.emit('slidestart', _this.getValue());
    ...
    hx.select(document).on('pointerup', (function(_this) {
      return function(e) {
        ...
        if (_.mouseDown) {
          ...
          return _this.emit('slideend', _this.getValue());
        }
      };
    })(this), true);
  ...
  slide = function(e) {
    var diff, end, isEnd, offset, pos, start, val, _;
    _ = this._;
    _.slidableWidth = this.options.type === 'range' ? _.container.width() - _.controlWidth : _.container.width();
    ...
    val = {};
    if (this.options.type === 'range') {
      start = _.isDiscrete ? discreteToPos.call(this, this.value.startValue) : this.value.startValue;
      end = _.isDiscrete ? discreteToPos.call(this, this.value.endValue) : this.value.endValue;
  ...
  renderValues = function() {
    var endValue, node, startValue, val, _;
    _ = this._;
    setTimeout(function() {
      var height, points;
    ...
    if (this.options.type === 'range') {
      startValue = _.isDiscrete ? discreteToPos.call(this, this.value.startValue) : this.value.startValue;
      endValue = _.isDiscrete ? discreteToPos.call(this, this.value.endValue) : this.value.endValue;
    } else {
      startValue = this.options.min;
      endValue = _.isDiscrete ? discreteToPos.call(this, this.value.value) : this.value.value;
    }
    if (!_.isDiscrete) {
    ...
    if (_.dragging === 'start') {
      node = _.valueL;
      val = this.value.startValue;
    } else if (_.dragging != null) {
      node = _.valueR;
      val = _.dragging === 'end' ? this.value.endValue : this.value.value;
    }
  ...
  Slider.prototype.setValue = function(value) {
    ...
    if (this.options.type === 'range') {
      if (value.startValue != null) {
        this.value.startValue = clamp(value.startValue);
      }
      if (value.endValue != null) {
        this.value.endValue = clamp(value.endValue);
      }
    } else {
      if (hx.isObject(value)) {
        if (value.value != null) {
          this.value.value = clamp(value.value);
        }
      } else {
        if (value != null) {
...
buildAutoComplete = function(searchTerm, fromCallback, loading) {
  var filteredData, message, self, trimAndReload, _;
  self = this;
  _ = this._;
...
DashboardWidget = (function() {
  function DashboardWidget(selector, options) {
    ...
    this.body = this.selection.append('div')["class"]('hx-widget-body-wrapper hx-section').append('div')["class"]('hx-widget-body').style('height', options.height ? options.height + 'px' : '');
...
Camera = (function(_super) {
  ...
  function Camera(drawing) {
    var mouseControlState, mouseDownHandler, touchUpHandler;
    ...
    mouseDownHandler = (function(_this) {
      return function(e) {
    ...
    hx.select(this.drawing.canvasNode).on('pointerdown', (function(_this) {
      return function() {
        hx.select(document).on('mouseup', mouseDownHandler, true);
        return hx.select(document).on('touchend', touchUpHandler, true);
      };
    })(this));
    hx.select(this.drawing.canvasNode).on('pointerup', (function(_this) {
      return function() {
        hx.select(document).off('mouseup', mouseDownHandler);
        return hx.select(document).off('touchend', touchUpHandler);
      };
    })(this));
  ...
  appendFilterDropdown = function(targetElement, clickElement, lowerCaseName, table) {
    ...
    populateDropdown = function(element) {
      ...
      appendFilterInput = function(elem, type) {
        var clearBtn, filterPlaceholder, timeout, typeStr, updateFilter, _ref;
        timeout = void 0;
        ...
        input[type] = inputBox[type].append('input').attr('placeholder', filterPlaceholder).value(oldValue[type] || ((_ref = _.modifiers.filters[lowerCaseName]) != null ? _ref[type] : void 0) || '');
        if (type === 'regex') {
      ...
      rowUpdate = function(d, rowElement, i) {
        ...
        if (rowCollapsibleEnabled) {
          buildCollapsible = function(node) {
            ...
            table.options.collapsibleRow(contentDiv.node(), data);
            return {
              contentRow: contentRow,
              hiddenRow: hiddenRow,
              visible: false
  ...
  Form.prototype.addSelect = function(name, values, options) {
    ...
    return this.add(name, 'select', 'select', function() {
      ...
      for (_i = 0, _len = values.length; _i < _len; _i++) {
        value = values[_i];
        this.append('option').text(hx.defined(value.text) ? value.text : value).attr('value', hx.defined(value.value) ? value.value : value);
      }
...
InlineSelect = (function(_super) {
  var enterEditMode, exitEditMode;

  __extends(InlineSelect, _super);

  enterEditMode = function(toggle, content) {
    var _ref;
    this.select.value(((_ref = this.current) != null ? _ref.value : void 0) || this.current);
    return hx.select(content).select('.hx-confirm').on('click', (function(_this) {
      return function() {
...
Paginator = (function(_super) {
  ...
  function Paginator(selector) {
    ...
    self = this;
    container.append('button').attr('type', 'button')["class"]('hx-btn ' + hx.theme.paginator.arrowButton).html('<i class="fa fa-step-backward"></i>').on('click', function() {
    ...
    this.view = pageButtons.view('.hx-btn', 'button').update(function(d, e, i) {
      return this.text(d.value).attr('type', 'button').classed(hx.theme.paginator.defaultButton, !d.selected).classed(hx.theme.paginator.selectedButton, d.selected).classed('hx-no-border', true).on('click', function() {
        return select(self, d.value, 'user');
      });
    });
    container.append('button').attr('type', 'button')["class"]('hx-btn ' + hx.theme.paginator.arrowButton).html('<i class="fa fa-step-forward"></i>').on('click', function() {
      if (self.pageCount === void 0) {
        return select(self, self.selected + 1, 'user');
      } else {
...
Select = (function(_super) {
  ...
  function Select(selector) {
    ...
    this.menu.on('select', (function(_this) {
      return function(item) {
        var _ref;
        if (((_ref = item.content) != null ? _ref.content : void 0) != null) {
          _this.current = item.content.content;
          _this.selectedText.text(_this.current.name || _this.current);
          _this.menu.hide();
...
TimeSlider = (function(_super) {
  var dateToValue, zeroPad;

  __extends(TimeSlider, _super);

  function TimeSlider(selector, options, render) {
    var end, start, t, _ref;
    if (typeof options === 'string' || (render != null)) {
      t = options;
      options = {
        type: t
    ...
    if (((_ref = options.discreteValues) != null ? _ref.length : void 0) > 0) {
      hx.consoleWarning(selector + ': hx.TimeSlider does not support the discreteValues option', 'Discrete values override the functionality of the time slider');
  ...
  TimeSlider.prototype.setValue = function(value) {
    ...
    if (this.options.type === 'range') {
      ...
      TimeSlider.__super__.setValue.call(this, {
        startValue: start,
        endValue: end
      });
    } else {
      TimeSlider.__super__.setValue.call(this, dateToValue(this, value));
    }
    return this;
  };
  ...
  TimeSlider.prototype.getValue = function() {
    if (this.options.type === 'range') {
      return {
        startValue: this.valueToDate(this.value.startValue),
        endValue: this.valueToDate(this.value.endValue)
      };
    } else {
      return this.valueToDate(this.value.value);
    }
  };
  ...
  TimeSlider.prototype.getRangeStartValue = function() {
    return this.getValue().startValue;
  };

  TimeSlider.prototype.getRangeEndValue = function() {
    return this.getValue().endValue;
  };
