...
ClickDetector = (function(superClass) {
  ...
  function ClickDetector() {
    ...
    hx.select(document).on('pointerdown', 'clickDetector-' + this.id, this.downAction);
    hx.select(document).on('pointerup', 'clickDetector-' + this.id, this.upAction);
  }
  ...
  ClickDetector.prototype.cleanUp = function() {
    hx.select(document).off('pointerdown', 'clickDetector-' + this.id, this.downAction);
    return hx.select(document).off('pointerup', 'clickDetector-' + this.id, this.upAction);
  };
...
ButtonGroup = (function(superClass) {
  ...
  function ButtonGroup(selector, options) {
    ...
    this.view = group.view('button').enter(function() {
      ...
      this.classed(self.options.buttonClass, false).classed(self.options.activeClass, false).classed(buttonClass, true).on('click', function() {
        self.value(item);
...
Table = (function(superClass) {
  ...
  function Table(selector, options) {
    ...
    _.rowsPerPageSelect.on('change', (function(_this) {
      return function(data) {
    ...
    _.pageSelect.on('change', (function(_this) {
      return function(d) {
    ...
    _.pageSelectBack.on('click', (function(_this) {
      return function() {
        var oldPage;
    ...
    _.pageSelectForward.on('click', (function(_this) {
      return function() {
        var oldPage;
        oldPage = _.currentPage;
        _.currentPage += 1;
  ...
  render = function(table, callback) {
    ...
    if (table.options.alwaysMobile) {
      ...
      if (!_.responsiveListenerAdded) {
        ...
        _.container.on('resize', 'hx.table.responsive', (function(_this) {
          return function() {
    ...
    _.container.on('resize', 'hx.table.header', function() {
    ...
    renderStickyHeader = function(next) {
      ...
      stickyHeaderUpdate = function(d, e, i) {
        ...
        this.select('.hx-table-header-name').on('click', sortFn);
        return this.select('.hx-table-sort-icon').on('click', sortFn);
      };
    ...
    renderMobilePage = function(next) {
      ...
      responsiveCellUpdate = function(d, e, i, screenRowIndex) {
        ...
        th.select('.hx-table-header-name').on('click', sortFn);
        th.select('.hx-table-sort-icon').on('click', sortFn);
...
Form = (function(superClass) {
  ...
  Form.prototype.addSelect = function(name, values, options) {
    ...
    return this.add(name, 'select', 'div', function() {
      ...
      elem.classed(c, true).on('click', 'form-select', function(e) {
        return e.preventDefault();
      });
