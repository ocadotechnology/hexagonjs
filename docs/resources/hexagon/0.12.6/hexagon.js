...
Select = (function(superClass) {
  ...
  function Select(selector, ddClass) {
    var button;
    ...
    this.menu = new hx.Menu(button.node(), null, null, ddClass || '');
...
Slider = (function(superClass) {
  ...
  slide = function(e) {
    ...
    _.mouseDown = true;
    hx.select(document).on('pointermove', 'hx.slider', (function(_this) {
      return function(e) {
        return slide.call(_this, e);
      };
    })(this));
    hx.select(document).on('pointerup', 'hx.slider', (function(_this) {
      return function(e) {
  ...
  slideEnd = function(e) {
    ...
    _ = this._;
    if (_.mouseDown) {
      hx.select(document).off('pointermove', 'hx.slider');
      hx.select(document).off('pointerup', 'hx.slider');
      _.mouseDown = false;
      _.dragging = void 0;
...
Table = (function(superClass) {
  ...
  function Table(selector, options) {
    ...
    _.rowsPerPageSelect = new hx.Select(rowSelectNode, 'hx-table-row-select-dropdown');
    ...
    _.pageSelect = new hx.Select(pageSelectNode, 'hx-table-page-select-dropdown');
