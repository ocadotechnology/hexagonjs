...
DatePicker = (function(superClass) {
  var disabled, setupCalendar, setupDatepicker, setupInput, setupWeek;
  ...
  function DatePicker(selector, type, closeOnSelect, selectRange) {
    var _, backMonthButton, calendarElem, calendarMonthHeader, dayNode, forwardMonthButton, icon, inputContainer, isDisabled, monthNode, self, setupDropdown, updateRangePicker, yearNode;
    this.selector = selector;
    ...
    if (this.selectRange) {
      ...
      isDisabled = (function(_this) {
        return function() {
          return _this.inputStart.attr('disabled') !== null || _this.inputEnd.attr('disabled') !== null;
        };
      })(this);
      ...
      isDisabled = (function(_this) {
        return function() {
          return _this.input.attr('disabled') !== null;
        };
      })(this);
