...
Selection = (function() {
  ...
  Selection.prototype.off = function(name, namespace, f) {
    var augmenter, data, j, k, len, len1, node, ref, ref1, ref2;
    if (!hx.isString(namespace)) {
      f = namespace;
      namespace = void 0;
    }
    ...
    for (j = 0, len = ref.length; j < len; j++) {
      ...
      if ((ref1 = data.eventAugmenters) != null ? ref1.has(name) : void 0) {
        for (k = 0, len1 = augmenters.length; k < len1; k++) {
          augmenter = augmenters[k];
          if (augmenter.name === name) {
            if (typeof augmenter.remove === "function") {
              augmenter.remove(node);
            }
          }
        }
        data.eventAugmenters["delete"](name);
      }
      if ((ref2 = data.eventEmitter) != null) {
        ref2.off(name, namespace, f);
      }
    }
    return this;
  };
  ...
  Selection.prototype.forEach = function(f) {
    this.nodes.map(select).forEach(f);
    return this;
  };
...
(function(){hx.select.addEventAugmenter({
  ...
  setup: function(node, eventEmitter) {
    node.__hx__.PointerEventsMousedown = function(e) {
    ...
    node.addEventListener('mousedown', node.__hx__.PointerEventsMousedown);
    if (hx.supports('touch')) {
      node.__hx__.PointerEventsTouchstart = function(e) {
        return eventEmitter.emit('pointerdown', {
      ...
      return node.addEventListener('touchstart', node.__hx__.PointerEventsTouchstart);
    }
  },
  remove: function(node) {
    node.removeEventListener('mousedown', node.__hx__.PointerEventsMousedown);
    if (hx.supports('touch')) {
      return node.removeEventListener('touchstart', node.__hx__.PointerEventsTouchstart);
    }
  }
});
...
hx.select.addEventAugmenter({
  name: 'pointermove',
  setup: function(node, eventEmitter) {
    node.__hx__.PointerEventsMousemove = function(e) {
    ...
    node.addEventListener('mousemove', node.__hx__.PointerEventsMousemove);
    if (hx.supports('touch')) {
      node.__hx__.PointerEventsTouchmove = function(e) {
        return eventEmitter.emit('pointermove', {
          x: e.targetTouches[0].clientX,
          y: e.targetTouches[0].clientY,
          event: e
      ...
      return node.addEventListener('touchmove', node.__hx__.PointerEventsTouchmove);
    }
  },
  remove: function(node) {
    node.removeEventListener('mousemove', node.__hx__.PointerEventsMousemove);
    if (hx.supports('touch')) {
      return node.removeEventListener('touchmove', node.__hx__.PointerEventsTouchmove);
    }
  }
});
...
hx.select.addEventAugmenter({
  name: 'pointerup',
  setup: function(node, eventEmitter) {
    node.__hx__.PointerEventsMouseup = function(e) {
    ...
    node.addEventListener('mouseup', node.__hx__.PointerEventsMouseup);
    if (hx.supports('touch')) {
      node.__hx__.PointerEventsTouchend = function(e) {
        return eventEmitter.emit('pointerup', {
          event: e
        });
      };
      node.addEventListener('touchend', node.__hx__.PointerEventsTouchend);
      return node.addEventListener('touchcancel', node.__hx__.PointerEventsTouchend);
    }
  },
  remove: function(node) {
    node.removeEventListener('mouseup', node.__hx__.PointerEventsMouseup);
    if (hx.supports('touch')) {
      node.removeEventListener('touchstart', node.__hx__.PointerEventsTouchend);
      return node.removeEventListener('touchcancel', node.__hx__.PointerEventsTouchend);
    }
  }
});
...
hx.select.addEventAugmenter({
  name: 'pointerleave',
  setup: function(node, eventEmitter) {
    node.__hx__.PointerEventsMouseleave = function(e) {
    ...
    node.addEventListener('mouseleave', node.__hx__.PointerEventsMouseleave);
    if (hx.supports('touch')) {
      node.__hx__.PointerEventsTouchleave = function(e) {
        return eventEmitter.emit('pointerleave', {
          event: e
        });
      };
      return node.addEventListener('touchleave', node.__hx__.PointerEventsTouchleave);
    }
  },
  remove: function(node) {
    node.removeEventListener('mouseleave', node.__hx__.PointerEventsMouseleave);
    if (hx.supports('touch')) {
      return node.removeEventListener('touchleave', node.__hx__.PointerEventsTouchleave);
    }
  }
});
...
hx.select.addEventAugmenter({
  name: 'pointerenter',
  setup: function(node, eventEmitter) {
    node.__hx__.PointerEventsMouseEnter = function(e) {
    ...
    node.addEventListener('mouseenter', node.__hx__.PointerEventsMouseEnter);
    if (hx.supports('touch')) {
      node.__hx__.PointerEventsTouchEnter = function(e) {
        return eventEmitter.emit('pointerenter', {
          event: e
        });
      };
      return node.addEventListener('touchenter', node.__hx__.PointerEventsTouchEnter);
    }
  },
  remove: function(node) {
    node.removeEventListener('mouseenter', node.__hx__.PointerEventsMouseenter);
    if (hx.supports('touch')) {
      return node.removeEventListener('touchenter', node.__hx__.PointerEventsTouchenter);
    }
  }
});
})();
...
ClickDetector = (function(superClass) {
  ...
  ClickDetector.prototype.cleanUp = function() {
    ...
    return hx.select(document).off('pointerup', 'hx.click-detector.' + this.eventId, this.upAction);
  };
...
Dropdown = (function(superClass) {
  ...
  Dropdown.prototype.show = function() {
    var bodyDiff, checkOverlap, ddHeight, ddMaxHeight, dropdownRect, horizontalOverlap, horizontalPos, horizontalWindow, invertY, movedVertical, node, parentFixed, parentZIndex, rect, scrolbarCounter, scrollbarWidth, spacing, verticalOverlap, verticalPos, verticalWindow, yPos;
  ...
  Dropdown.prototype.hide = function() {
    if (this.visible) {
      ...
      this.dropdown = void 0;
      return this.clickDetector.off('click', 'hx.dropdown');
    }
  };
...
initToggleButtons = function(selection) {
  ...
  hx.selectAll(selection).map(function(d) {
    ...
    if (d.classed('hx-btn-toggle')) {
      arr.push(d.node());
      return d.attr('data', !d.classed('hx-btn-toggle-off')).on('click', 'hx.button', function(e) {
        var val;
...
(function(){var Menu, MenuItem, addItem, checkEvent, dealWithEvent, dropdownContent, getAllItems, moveSelectionDown, moveSelectionUp, setActive, setupInner, setupItems, toggleCollapsible,
  extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
  hasProp = {}.hasOwnProperty;
...
setupItems = function(self, data, reload) {
  self.clearItems();
  setupInner(self, data, self);
  self.dropdown.dropdownContent = dropdownContent(function() {
    return self.items;
  });
...
Menu = (function(superClass) {
  ...
  function Menu(selector, align, mode, ddClass) {
    ...
    selection.on('click', 'hx.dropdown', (function(_this) {
      return function() {
        var loading;
        if (_this.dropdown.isOpen()) {
          ...
          if (!_this.loading) {
            if ((_this.data != null) && hx.isFunction(_this.data)) {
              ...
              return _this.data(function(data) {
                self.loading = false;
                loading.remove();
                return setupItems(self, data);
              });
            } else if (_this.data != null) {
              return setupItems(_this, _this.data);
            } else {
              _this.dropdown.dropdownContent = dropdownContent(function() {
                return self.items;
              });
    ...
    this.dropdown.on('show', 'hx.menu', function() {
      self.cursorPos = -1;
      if (!isInput) {
  ...
  Menu.prototype.renderer = function(element, item) {
    return hx.select(element).html(item).on('click', 'hx.menu', (function(_this) {
      return function() {
...
hx.select.addEventAugmenter({
  ...
  setup: function(node, eventEmitter) {
    ...
    node.__hx__.ResizeEventsResize = function(e) {
      var box;
    ...
    return addResizeListener(node, node.__hx__.ResizeEventsResize);
  },
  remove: function(node) {
    return removeResizeListener(node, node.__hx__.ResizeEventsResize);
  }
});
})();
(function(){var Select,
...
Select = (function(superClass) {
  ...
  function Select(selector, options) {
    ...
    this.menu = new hx.Menu(selector, null, null, this.options.ddClass || '');
    this.menu.on('select', 'hx.select', (function(_this) {
  ...
  Select.prototype.value = function(value) {
    var loading;
    if (arguments.length > 0) {
      if (hx.isFunction(this.selectItems)) {
        loading = this.selection.prepend('span');
        loading.append('i')["class"]('hx-menu-loading fa fa-spin fa-spinner');
        this.selectItems((function(_this) {
        ...
        setValue(this, value, this.selectItems);
      }
      return this;
    } else {
      return this.current;
  ...
  function DatePicker(selector, options) {
    ...
    if (typeof options === 'string') {
      ...
      for (i = j = 2, ref = arguments.length; 2 <= ref ? j <= ref : j >= ref; i = 2 <= ref ? ++j : --j) {
        options[remaining[i - 2]] = arguments[i];
      }
    }
    _ = this._ = {};
    ...
    _.feed.on('calendarchange', 'hx.date-picker', (function(_this) {
      return function(e) {
        return setupCalendar.call(_this);
      };
    })(this)).on('change', 'hx.date-picker', (function(_this) {
      return function(e) {
    ...
    if (this.options.selectRange) {
      updateRangePicker = function(which) {
        ...
        if (!self.suppressCallback) {
          date1 = self.localiser.stringToDate(self.inputStart.value(), self.useInbuilt);
          date2 = self.localiser.stringToDate(self.inputEnd.value(), self.useInbuilt);
          ...
          if (startValid && endValid) {
            ...
            self.showMonth(date1.getMonth() + 1, date1.getFullYear());
          }
          self.inputStart.classed('hx-date-error', !startValid);
          return self.inputEnd.classed('hx-date-error', !endValid);
        }
      };
      this.inputStart = inputContainer.append('input')["class"]('hx-date-input').on('input', 'hx.date-picker', function() {
        return updateRangePicker(false);
      });
      inputContainer.append('i')["class"]('hx-date-to-icon fa fa-angle-double-right');
      this.inputEnd = inputContainer.append('input')["class"]('hx-date-input').on('input', 'hx.date-picker', function() {
      ...
      this.input = inputContainer.append('input')["class"]('hx-date-input').on((this.useInbuilt ? 'blur' : 'input'), 'hx.date-picker', function(event) {
        var date;
        date = self.localiser.stringToDate(event.target.value, self.useInbuilt);
        if (date.getTime()) {
          self.date(date, true);
    ...
    if (this.options.type === 'calendar') {
      ...
      this.calendarHeaderBtn = calendarHeader.append('button')["class"]('hx-btn hx-btn-invisible hx-calendar-button').on('click', 'hx.date-picker', function() {
        switch (_.currView) {
          case 'd':
            break;
          case 'y':
      ...
      if (this.options.showTodayButton) {
        this.calendarTodayButton = calendarElem.append('div')["class"]('hx-calendar-today-btn').append('button')["class"]('hx-btn hx-btn-invisible').text(this.localiser.localiseToday()).on('click', 'hx.date-picker', function() {
          var date;
          date = new Date();
          date.setHours(0, 0, 0, 0);
          self.date(date);
      ...
      this.dayPicker = new hx.NumberPicker(dayNode).on('change', 'hx.date-picker', (function(_this) {
        return function(e) {
          if (!_this.suppressCallback) {
      ...
      this.monthPicker = new hx.NumberPicker(monthNode).on('change', 'hx.date-picker', (function(_this) {
        return function(e) {
          if (!_this.suppressCallback) {
      ...
      this.yearPicker = new hx.NumberPicker(yearNode).on('change', 'hx.date-picker', (function(_this) {
        return function(e) {
          if (!_this.suppressCallback) {
...
TimePickerFeed = (function(superClass) {
  ...
  TimePickerFeed.prototype.date = function(date, retainTime) {
...
TimePicker = (function(superClass) {
  ...
  function TimePicker(selector, showSeconds1, buttonClass) {
    ...
    _.feed.on('change', 'hx.time-picker', (function(_this) {
      return function(e) {
        if (!_this.preventFeedback) {
          _this.preventFeedback = true;
    ...
    this.hourPicker = new hx.NumberPicker(hourNode, buttonClass).on('change', 'hx.time-picker', (function(_this) {
      return function(e) {
        if (!_this.suppressCallback) {
    ...
    this.minutePicker = new hx.NumberPicker(minuteNode, buttonClass).on('change', 'hx.time-picker', (function(_this) {
      return function(e) {
        if (!_this.suppressCallback) {
    ...
    this.secondPicker = new hx.NumberPicker(second, buttonClass).on('change', 'hx.time-picker', (function(_this) {
      return function(e) {
        if (!_this.suppressCallback) {
  ...
  TimePicker.prototype.date = function(val, retainTime, suppressCallback) {
    this.suppressCallback = suppressCallback != null ? suppressCallback : false;
    return this._.feed.date(val, retainTime) || this;
  };
...
StickyTableHeaders = (function(superClass) {
  ...
  function StickyTableHeaders(selector, options) {
    ...
    if (this.options.stickTableHead && this.table.select('thead').select('tr').empty()) {
      hx.consoleWarning('hx.StickyTableHeaders - ' + selector, 'Sticky table headers initialised without thead element');
...
makeButtons = function(container, buttons, modal, callback) {
  buttons.forEach(function(d) {
    return container.append('button').attr('type', 'button')["class"](d.classes).html("<i class='" + d.icon + "'></i> " + d.text).on('click', 'hx.modal', function() {
      callback(d.value);
      return modal.close();
    });
  });
...
Notification = (function() {
  function Notification(manager1, message1, icon1, cssclass1, pinned1) {
    ...
    this.pinned = pinned1;
    this.domPin = hx.detached('i').attr('class', 'hx-notification-pin fa fa-thumb-tack').on('click', 'hx.notify', (function(_this) {
      return function() {
...
NotificationManager = (function() {
  ...
  setupNotification = function(notification, selection) {
    selection.append('i').attr('class', 'hx-notification-icon ' + notification.icon).insertAfter('div').attr('class', 'hx-notification-text').text(notification.message).insertAfter('i').attr('class', 'hx-notification-close fa fa-times').on('click', 'hx.notify', function() {
...
Slider = (function(superClass) {
  var defaultOptions, discreteToPos, posToDiscrete, posToValue, renderValues, slide, slideEnd;
...
AutoComplete = (function(superClass) {
  ...
  function AutoComplete(selector, data1, options) {
    ...
    if (!hx.isArray(this.data) && !hx.isFunction(this.data)) {
      ...
      menu.on('select', 'hx.autocomplete', function(d) {
        var content, ref;
      ...
      menu.on('show', 'hx.autocomplete', function() {
        _.initialValue = input.value();
        return menu.dropdown.useScroll = true;
      });
      menu.on('hide', 'hx.autocomplete', function() {
        var exactMatch;
        _.cleanUp = true;
        if (!_.ignoreMatch) {
...
ButtonGroup = (function(superClass) {
  ...
  function ButtonGroup(selector, options) {
    ...
    this.view = group.view('button').enter(function() {
      ...
      self.renderFunc(node, item, item === self.current);
    });
    this.renderFunc = function(node, data, current) {
  ...
  ButtonGroup.prototype.items = function(items) {
    ...
    this.view.apply(this.buttonItems);
    return this;
  };
...
DateTimePicker = (function(superClass) {
  ...
  function DateTimePicker(selector, type, showSeconds) {
    ...
    this.datePicker = new hx.DatePicker(dtNode, {
      type: type
    });
    ...
    this.datePicker.on('change', 'hx.date-time-picker', (function(_this) {
      return function() {
        _this.timePicker.date(_this.datePicker.date(), true, true);
        if (!_this.suppressCallback) {
  ...
  DateTimePicker.prototype.date = function(val, retainTime, suppressCallback) {
    var date;
    this.suppressCallback = suppressCallback || false;
    date = this.timePicker.date(val, retainTime, suppressCallback);
...
(function(){var removeFastClick, setupFastClick;
...
if (hx.supports('touch')) {
  setupFastClick = function(node, eventEmitter) {
    ...
    startX = void 0;
    startY = void 0;
    node.__hx__.FastClickTouchstart = function(e) {
      var ref;
    ...
    node.__hx__.FastClickTouchmove = function(e) {
      var coords;
      if (!cancel) {
        coords = getCoords(e);
    ...
    node.__hx__.FastClickTouchend = function(e) {
    ...
    node.addEventListener('touchstart', node.__hx__.FastClickTouchstart);
    node.addEventListener('touchmove', node.__hx__.FastClickTouchmove);
    return node.addEventListener('touchend', node.__hx__.FastClickTouchend);
  };
  removeFastClick = function(node) {
    node.removeEventListener('touchstart', node.__hx__.FastClickTouchstart);
    node.removeEventListener('touchmove', node.__hx__.FastClickTouchmove);
    return node.removeEventListener('touchend', node.__hx__.FastClickTouchend);
  };
  hx.select.addEventAugmenter({
    name: 'click',
    setup: setupFastClick,
    remove: removeFastClick
  });
}
})();
(function(){var Form,
...
Form = (function(superClass) {
  ...
  Form.prototype.addDatePicker = function(name, options) {
    ...
    this.add(name, 'datepicker', 'div', function() {
      ...
      datepicker = new hx.DatePicker(elem, options.type, options.closeOnSelect, options.selectRange);
      if (options.disabled) {
        datepicker.disable();
      }
  ...
  Form.prototype.addTimePicker = function(name, options) {
    ...
    this.add(name, 'timepicker', 'div', function() {
      ...
      elem = this.append('div').node();
      timepicker = new hx.TimePicker(elem, options.showSeconds, options.buttonClass);
      if (options.disabled) {
        timepicker.disable();
      }
      getValue = function() {
  ...
  Form.prototype.addDateTimePicker = function(name, options) {
    ...
    this.add(name, 'datetimepicker', 'div', function() {
      ...
      elem = this.append('div').node();
      datetimepicker = new hx.DateTimePicker(elem, options.type, options.showSeconds);
      if (options.disabled) {
  ...
  Form.prototype.addTagInput = function(name, options) {
    ...
    this.add(name, 'tagInput', 'div', function() {
      ...
      new hx.TagInput(this.node(), classifier, validator);
      return {
        key: options.key
      };
    });
...
Meter = (function() {
  ...
  Meter.prototype.value = function(data) {
    if (arguments.length > 0) {
      this._.data = hx.merge(true, this._.data, data);
      this.render();
      return this;
    } else {
      return this._.data;
  ...
  Meter.prototype.render = function() {
    ...
    svg = _.svg;
    progress = (data.completed / data.total) || 0;
    trackerProgress = (data.tracker / data.total) || 0;
    markerProgress = (data.marker / data.total) || 0;
...
UserPreferences = (function(superClass) {
  ...
  setupModal = function(elem, data, userPreferences) {
    ...
    form = new hx.Form(node).on('submit', 'hx.preferences', function(formData) {
      var savingLoading;
    ...
    if (!_.modal) {
      ...
      this.value(function(error, data) {
        ...
        if (error) {
          ...
          _.modal.show();
          return _.modal.on('close', 'hx.preferences', function() {
