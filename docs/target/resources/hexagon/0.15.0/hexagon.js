...
renderStickyHeaders = function() {
  ...
  this.wrapper.style('height', '').style('width', '').style('margin-left', '').style('margin-right', '');
  ...
  if (this.options.stickTableHead) {
    ...
    if (wrapperNode.scrollHeight > wrapperNode.clientHeight || this.options.alwaysSticky) {
      addedTopSticky = true;
  ...
  totalHeight = this.container.style('height').replace('px', '') - this.heightOffset + heightScrollOffset * 1;
  ...
  Axis.prototype.getYStack = function(type, group, x, seriesId, start) {
    ...
    if (group) {
      ...
      for (j = k = 0, len = ref.length; k < len; j = ++k) {
        series = ref[j];
        if (series.seriesId < seriesId && series.group === group && series.type === type) {
          ys = series.getY(x, this.xScaleType === 'discrete');
          if (hx.defined(ys)) {
            yStack += ys;
          }
        }
...
DataTable = (function(superClass) {
  ...
  function DataTable(selector, options) {
    ...
    filterInput = footer.append('input')["class"]('hx-data-table-filter-control').attr('placeholder', 'filter').classed('hx-data-table-filter-visible', resolvedOptions.filterEnabled).on('input', 'hx.data-table', onInput);
    ...
    pagePicker = new hx.Picker(pagePickerNode, {
      ...
      return function(d) {
        if (d.cause === 'user') {
          return _this.page(d.value, void 0, d.cause);
        }
      };
    })(this));
    ...
    pagePickerBack.append('i')["class"]('fa fa-chevron-left');
    ...
    pagePickerForward.append('i')["class"]('fa fa-chevron-right');
  ...
  DataTable.prototype.suppressRender = function(value) {
    if (arguments.length > 0) {
      this._.suppressRender = value;
      return this;
    } else {
      return this._.suppressRender;
    }
  };
        ...
        return feed.totalCount(function(totalCount) {
          ...
          return feed.rows({
            ...
            if (options.selectEnabled && !options.singleSelection) {
              ...
              headerCheckBox.append('i')["class"]('fa fa-check');
            }
            headers.forEach(function(header, i) {
              ...
              if (getColumnOption('sortEnabled', header.id)) {
                ...
                currentSort = _this.sort();
                dirClass = currentSort && currentSort.column === header.id ? 'fa-sort-' + currentSort.direction + ' hx-data-table-sort-on' : 'fa-sort';
                cellDivContent.append('i')["class"]('fa ' + dirClass + ' hx-data-table-sort-icon');
            ...
            toggleCollapsible = function(node, row, force) {
              ...
              node.select('.hx-data-table-collapsible-toggle').select('i')["class"](currentVis ? 'fa fa-minus' : 'fa fa-plus');
              if (currentVis) {
            ...
            if (filteredCount === void 0 || filteredCount > 0) {
              rows.forEach(function(row, rowIndex) {
                ...
                tr.on('click', 'hx.data-table', function(e) {
                  return _this.emit('rowclick', row);
                });
                ...
                if (options.selectEnabled || (options.collapsibleRenderer != null)) {
                  ...
                  if (options.selectEnabled) {
                    ...
                    checkbox.append('i')["class"]('fa fa-check');
                  ...
                  if (options.collapsibleRenderer != null) {
                    ...
                    collapsibleControl.append('i')["class"]('fa fa-plus');
                  }
                  if (rowIsCollapsible) {
