...
var toMultilineSelection$1 = userFacingText.toMultilineSelection;
...
Stepper.prototype.selectedStep = function selectedStep (selectedStep$1) {
  if (arguments.length) {
    ...
    if (selectedStep$1 && selectedStep$1 > 0 && selectedStep$1 <= numSteps) {
      this._.selectedStep = selectedStep$1;
...
Stepper.prototype.showError = function showError (showError$1) {
  if (arguments.length) {
    if (this._.showError !== showError$1) {
      this._.showError = showError$1;
      this.render();
    }
    return this;
  }
