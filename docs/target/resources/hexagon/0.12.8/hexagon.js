...
Selection = (function() {
  ...
  Selection.prototype.on = function(name, namespace, f, retain) {
    var augmenter, data, eventEmitter, handlerRemoverFunctions, j, k, len, len1, node, ref;
    if (retain != null) {
...
addAugmentor = function(name, mouseName, touchNames, node, addEventAugmenter, mouseEventFactory, touchEventFactory) {
  return hx.select.addEventAugmenter({
    ...
    setup: function(node, eventEmitter) {
      var i, len, mouseHandler, touchHandler, touchName;
      mouseHandler = function(e) {
        return eventEmitter.emit(name, mouseEventFactory(e));
      };
      node.addEventListener(mouseName, mouseHandler);
      return function() {
        return node.removeEventListener(mouseName, mouseHandler);
      };
